...
tag @s add animation.sculkadillo.animation.idle_left.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.idle_left.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function fossil_frights:animations/dinocoin/crane/rig/animations/idle_left/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/dinocoin/crane/rig/animations/idle_left/zzz/apply_frame {frame: $(to_frame)}
