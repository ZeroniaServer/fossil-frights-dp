...
tag @s add animation.vending_machine.animation.fill_velocitea.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.fill_velocitea.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function fossil_frights:animations/dinocoin/vending_machine/rig/animations/fill_velocitea/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/dinocoin/vending_machine/rig/animations/fill_velocitea/zzz/apply_frame {frame: $(to_frame)}
