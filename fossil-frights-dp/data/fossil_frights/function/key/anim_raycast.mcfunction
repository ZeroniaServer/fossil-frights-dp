...
execute if entity @e[type=minecraft:item_display,tag=ff_lock,distance=..0.35,sort=nearest,limit=1] as @e[type=minecraft:item_display,tag=ff_lock,distance=..0.35,sort=nearest,limit=1] at @s run function fossil_frights:key/spawn_anim
