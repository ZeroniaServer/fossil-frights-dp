...
execute if score $wash_muddy_sherd_sel ff_task_state matches 1 if score $wash_muddy_sherd_done ff_task_state matches 0 positioned 55.5 68.5 61.5 run playsound minecraft:entity.generic.splash block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.8 1.2
