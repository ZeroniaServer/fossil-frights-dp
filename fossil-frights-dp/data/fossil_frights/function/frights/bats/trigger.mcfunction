...
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
...
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright","ff_bats_fright_big"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright","ff_bats_fright_big"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright","ff_bats_fright_big"],PersistenceRequired:1b}
summon minecraft:bat ^ ^1.1 ^0.3 {Tags:["ff_bats_fright","ff_bats_fright_big"],PersistenceRequired:1b}
