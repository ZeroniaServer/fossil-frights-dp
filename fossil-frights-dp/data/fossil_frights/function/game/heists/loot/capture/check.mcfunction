...
execute if items entity @s contents *[custom_data~{itemID:"chlorine_tablet"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_chlorine_tablet"}
execute if items entity @s contents *[custom_data~{itemID:"scrap_metal"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_scrap_metal"}
execute if items entity @s contents *[custom_data~{itemID:"soap"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_soap"}
execute if items entity @s contents *[custom_data~{itemID:"dry_ice"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_dry_ice"}
execute if items entity @s contents *[custom_data~{itemID:"fire_tablet"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_fire_tablet"}
execute if items entity @s contents *[custom_data~{itemID:"golden_nautilus"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_golden_nautilus"}
execute if items entity @s contents *[custom_data~{itemID:"skeleton_plushie"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_skeleton_plushie"}
...
execute if items entity @s contents *[custom_data~{itemID:"sponge"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_sponge"}
execute if items entity @s contents *[custom_data~{itemID:"cotton_candy_pink"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_cotton_candy"}
execute if items entity @s contents *[custom_data~{itemID:"credit_reel"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_credit_reel"}
...
execute if items entity @s contents *[custom_data~{itemID:"muddy_sherd"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_muddy_sherd"}
