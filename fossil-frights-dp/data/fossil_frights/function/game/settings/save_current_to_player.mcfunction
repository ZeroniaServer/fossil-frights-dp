...
execute if block 10 71 24 minecraft:lever[powered=true] run tag @s remove ff_settings_chat_hidden
execute unless block 10 71 24 minecraft:lever[powered=true] run tag @s add ff_settings_chat_hidden
