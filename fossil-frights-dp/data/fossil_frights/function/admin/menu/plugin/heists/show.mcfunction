execute if score $heist_round_active ff_game_state matches 1 run function fossil_frights:admin/menu/plugin/heists/show_round
...
execute if score $heist_players_ready ff_game_state matches 1 run function fossil_frights:admin/menu/plugin/heists/show_waiting_ready
execute if score $heist_players_ready ff_game_state matches 1 run return 0
function fossil_frights:admin/menu/plugin/heists/show_waiting_force
