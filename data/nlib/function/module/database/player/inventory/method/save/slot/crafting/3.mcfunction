...
# save player.crafting.3
item replace entity @s contents from entity @p[tag=THIS_PLAYER_] player.crafting.3
data modify storage nlib:dummy dummy.slot.special append from entity @s item
data modify storage nlib:dummy dummy.slot.special[-1].Slot set value 4b
kill @s
