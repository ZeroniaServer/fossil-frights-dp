...
execute if data entity @s {SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{ff_temple_run_restart:1b}}}} unless score @s ff_temple_run_restart_use = @s ff_temple_run_restart_seen run function fossil_frights:temple_run/restart
