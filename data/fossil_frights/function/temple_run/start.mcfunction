...
clear @s
item replace entity @s weapon.mainhand with minecraft:carrot_on_a_stick[minecraft:item_name={text:"Temple Run Restart",color:"yellow",italic:false},minecraft:lore=[{text:"Restart ",color:"yellow",italic:false,extra:[{text:"- Right Click",color:"white",italic:false}]},{text:"End ",color:"red",italic:false,extra:[{text:"- Drop",color:"white",italic:false}]}],minecraft:item_model="fossil-frights:general_items/temple_run_restart",minecraft:custom_data={ff_temple_run_restart:1b}] 1
