...
data modify storage fossil_frights:temple_run best.name set from entity @s bukkit.lastKnownName
data modify storage fossil_frights:temple_run best.profile.name set from entity @s bukkit.lastKnownName
