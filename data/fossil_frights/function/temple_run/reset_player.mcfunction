...
execute if data entity @s {SelectedItem:{id:"minecraft:amethyst_shard",components:{"minecraft:custom_data":{ff_temple_run_restart:1b}}}} run item replace entity @s weapon.mainhand with air
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:amethyst_shard",components:{"minecraft:custom_data":{ff_temple_run_restart:1b}}}]} run item replace entity @s weapon.offhand with air
