...
execute if items entity @s weapon.mainhand minecraft:amethyst_shard[custom_data~{ff_temple_run_restart:1b}] run item replace entity @s weapon.mainhand with air
