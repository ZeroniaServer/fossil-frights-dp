...
scoreboard players set #lava_phase ff_hazard_rng 4
scoreboard players set #lava_anim_phase ff_hazard_rng 4
scoreboard players set #lava_anim_timer ff_hazard_rng 10
playsound minecraft:block.lava.ambient master @a ~ ~ ~ 1.1 0.8
