...
place template minecraft:lava_phase_3 -26 69 17
...
execute if score $heist_round_active ff_game_state matches 1 run place template minecraft:lava_fh -26 69 17
