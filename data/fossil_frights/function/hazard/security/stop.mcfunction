...
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^0 ^0 ^1 ^0 ^0 minecraft:air replace minecraft:stripped_pale_oak_wood
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^0 ^1 ^1 ^0 ^1 minecraft:air replace minecraft:polished_blackstone_button
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^0 ^-1 ^1 ^0 ^-1 minecraft:air replace minecraft:polished_blackstone_button
...
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s run playsound minecraft:block.piston.contract block @a ~ ~ ~ 1.25 0.95
