...
execute at @s rotated as @s run fill ^-2 ^4 ^0 ^2 ^4 ^0 minecraft:iron_bars
...
execute at @s rotated as @s positioned ^1 ^4 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute at @s rotated as @s positioned ^2 ^4 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute at @s rotated as @s run fill ^-2 ^5 ^0 ^2 ^5 ^0 minecraft:iron_bars replace minecraft:polished_tuff_wall
execute at @s rotated as @s run fill ^-2 ^5 ^0 ^2 ^5 ^0 minecraft:iron_bars replace minecraft:tuff_brick_wall
