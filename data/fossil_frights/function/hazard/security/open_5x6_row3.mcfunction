...
execute as @e[type=minecraft:marker,tag=ff_gate_5x6] at @s rotated as @s run fill ^-2 ^3 ^0 ^2 ^3 ^0 minecraft:air replace minecraft:iron_bars
execute as @e[type=minecraft:marker,tag=ff_gate_5x6] at @s rotated as @s run fill ^-2 ^3 ^0 ^2 ^3 ^0 minecraft:air replace minecraft:polished_tuff_wall
execute as @e[type=minecraft:marker,tag=ff_gate_5x6] at @s rotated as @s run fill ^-2 ^3 ^0 ^2 ^3 ^0 minecraft:air replace minecraft:tuff_brick_wall
