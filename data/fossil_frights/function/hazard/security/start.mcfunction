...
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^2 ^0 ^1 ^2 ^0 minecraft:stripped_pale_oak_wood
...
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^-1 ^2 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^0 ^2 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^1 ^2 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s run playsound minecraft:block.piston.extend block @a ~ ~ ~ 1.25 1.05
...
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s run setblock ^-1 ^5 ^0 minecraft:polished_tuff_wall
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s run setblock ^0 ^5 ^0 minecraft:tuff_brick_wall
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s run setblock ^1 ^5 ^0 minecraft:polished_tuff_wall
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s run setblock ^2 ^5 ^0 minecraft:lodestone
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s positioned ^-2 ^5 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s positioned ^-1 ^5 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s positioned ^0 ^5 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s positioned ^1 ^5 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s rotated as @s positioned ^2 ^5 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_player
execute as @e[type=minecraft:armor_stand,tag=ff_gate_5x6] at @s run playsound minecraft:block.piston.extend block @a ~ ~ ~ 1.25 1.05
