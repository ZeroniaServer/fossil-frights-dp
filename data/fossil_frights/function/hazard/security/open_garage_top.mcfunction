...
execute as @e[type=minecraft:marker,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^2 ^0 ^1 ^2 ^0 minecraft:air replace minecraft:stripped_pale_oak_wood strict
