...
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s run fill ^-1 ^1 ^0 ^1 ^1 ^0 minecraft:stripped_pale_oak_wood
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^-1 ^1 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^0 ^1 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s rotated as @s positioned ^1 ^1 ^0 as @a[distance=..0.75] run function fossil_frights:hazard/security/crush_garage_player
execute as @e[type=minecraft:armor_stand,tag=ff_garage_3x3] at @s run playsound minecraft:block.piston.extend block @a ~ ~ ~ 1.25 0.95
