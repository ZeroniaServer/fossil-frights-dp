...
execute at @s rotated as @s run fill ^-1 ^0 ^0 ^1 ^0 ^0 minecraft:air replace minecraft:stripped_pale_oak_wood
execute at @s rotated as @s run fill ^-1 ^0 ^1 ^1 ^0 ^1 minecraft:air replace minecraft:polished_blackstone_button
execute at @s rotated as @s run fill ^-1 ^0 ^-1 ^1 ^0 ^-1 minecraft:air replace minecraft:polished_blackstone_button
