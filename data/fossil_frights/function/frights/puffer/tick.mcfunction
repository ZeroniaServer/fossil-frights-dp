...
execute as @e[type=minecraft:pufferfish,tag=ff_pufferfish_fright,limit=1] at @s unless entity @a[limit=1,tag=ff_active,distance=..6] run scoreboard players set $puffer_timer ff_game_state 0
