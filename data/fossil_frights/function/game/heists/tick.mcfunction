...
execute if score $heist_round_active ff_game_state matches 0 if entity @a[tag=ff_in_queue] if score $heist_wait_ticks ff_heist matches 3600.. run function fossil_frights:game/reset
