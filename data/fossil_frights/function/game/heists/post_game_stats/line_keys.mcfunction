...
execute as @a[team=ff_thief] if score @s ff_heist_keys_stolen_round = $heist_keys_stolen_round_max ff_heist_keys_stolen_round run tag @s add ff_heist_stat_winner
