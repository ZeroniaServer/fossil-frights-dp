...
loot replace entity @s container.0 loot fossil_frights:items/heists/camera_remote
...
loot replace entity @s container.3 loot fossil_frights:items/heists/loot_book
loot replace entity @s container.4 loot fossil_frights:items/heists/night_stick
