...
execute if items entity @s contents *[custom_data~{itemID:"basketball"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_basketball"}
...
execute if items entity @s contents *[custom_data~{itemID:"hoverboard"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_hoverboard"}
execute if items entity @s contents *[custom_data~{itemID:"sniffer_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_sniffer_dna_cloth"}
execute if items entity @s contents *[custom_data~{itemID:"trike_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_trike_dna_cloth"}
execute if items entity @s contents *[custom_data~{itemID:"t_rex_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_t_rex_dna_cloth"}
execute if items entity @s contents *[custom_data~{itemID:"velociraptor_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_velociraptor_dna_cloth"}
execute if items entity @s contents *[custom_data~{itemID:"plesiosaur_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_plesiosaur_dna_cloth"}
execute if items entity @s contents *[custom_data~{itemID:"pterodactyl_dna_cloth"}] run function fossil_frights:game/heists/loot/capture/apply_keyed {key:"$loot_pterodactyl_dna_cloth"}
