...
execute if score $loot_biplane ff_heist_loot_value matches 1 run scoreboard players set $loot_biplane ff_heist_loot_value 400
execute if score $loot_biplane ff_heist_loot_value matches 2 run scoreboard players set $loot_biplane ff_heist_loot_value 450
execute if score $loot_biplane ff_heist_loot_value matches 3 run scoreboard players set $loot_biplane ff_heist_loot_value 500
