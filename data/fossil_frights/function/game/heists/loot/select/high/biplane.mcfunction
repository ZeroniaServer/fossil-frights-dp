...
execute store result score $loot_biplane ff_heist_loot_value run random value 1..4
...
execute if score $loot_biplane ff_heist_loot_value matches 4 run scoreboard players set $loot_biplane ff_heist_loot_value 500
