...
execute if score $loot_sand_dollar ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_sand_dollar_click,limit=1] run function fossil_frights:game/heists/loot/low/spawn/sand_dollar
