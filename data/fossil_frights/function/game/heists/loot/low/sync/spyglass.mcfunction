...
execute if score $loot_spyglass ff_heist_loot_state matches 0..1 as @e[tag=spyglass] run data merge entity @s {view_range:1f}
execute if score $loot_spyglass ff_heist_loot_state matches 2..3 as @e[tag=spyglass] run data merge entity @s {view_range:0f}
