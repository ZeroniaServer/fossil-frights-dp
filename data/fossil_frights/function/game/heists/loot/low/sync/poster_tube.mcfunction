...
execute if score $loot_poster_tube ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_poster_tube_click,limit=1] run function fossil_frights:game/heists/loot/low/spawn/poster_tube
