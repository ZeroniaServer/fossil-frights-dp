...
loot give @s loot fossil_frights:items/heists/loot/high_heavy/velociraptor_statue
...
function fossil_frights:game/heists/loot/high_heavy/sync/velociraptor_statue
