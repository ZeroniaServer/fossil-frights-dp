...
execute if score $loot_vault ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_vault_click,limit=1] run function fossil_frights:game/heists/loot/high_heavy/spawn/vault
