...
execute unless entity @e[type=minecraft:interaction,tag=ff_heist_waiting_text_click,limit=1] run summon minecraft:interaction -1.0 110.8 53.05 {width:3.0f,height:0.8f,response:1b,Tags:["ff_heist_waiting_text_click"]}
