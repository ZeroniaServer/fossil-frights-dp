...
data merge entity @e[type=minecraft:text_display,tag=ff_game_timer,limit=1] {text:[{"text":"--:--.--","color":"#A6FBFF"}],text_opacity:-70b,transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2f,2f,2f]}}
