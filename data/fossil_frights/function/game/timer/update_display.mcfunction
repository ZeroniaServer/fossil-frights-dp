execute unless score $timer_started ff_day matches 1 run data merge entity @e[type=minecraft:text_display,tag=ff_game_timer,limit=1] {text:[{"text":"--:--.--","color":"#A6FBFF"}],text_opacity:-70b,transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2f,2f,2f]}}
...
data merge entity @e[type=minecraft:text_display,tag=ff_game_timer,limit=1] {text:[{"score":{"name":"$timer_min_tens","objective":"ff_day"},"color":"#A6FBFF"},{"score":{"name":"$timer_min_ones","objective":"ff_day"},"color":"#A6FBFF"},{"text":":","color":"#A6FBFF"},{"score":{"name":"$timer_sec_tens","objective":"ff_day"},"color":"#A6FBFF"},{"score":{"name":"$timer_sec_ones","objective":"ff_day"},"color":"#A6FBFF"},{"text":".","color":"#A6FBFF"},{"score":{"name":"$timer_centi_tens","objective":"ff_day"},"color":"#A6FBFF"},{"score":{"name":"$timer_centi_ones","objective":"ff_day"},"color":"#A6FBFF"}],text_opacity:-70b,transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2f,2f,2f]}}
