...
execute if score $run_multiplayer ff_game_state matches 1 if score $party_mode_active ff_game_state matches 1 unless entity @a[tag=ff_active] run return run function fossil_frights:game/end
...
execute if score $run_multiplayer ff_game_state matches 1 unless score $party_mode_active ff_game_state matches 1 unless score $active_online ff_game_state = $party_member_count ff_game_state run function fossil_frights:game/handle_multiplayer_disconnect
