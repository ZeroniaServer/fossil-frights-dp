...
execute store result score $active ff_active_uuid_0 run data get storage fossil_frights:uuid this[0]
execute store result score $active ff_active_uuid_1 run data get storage fossil_frights:uuid this[1]
execute store result score $active ff_active_uuid_2 run data get storage fossil_frights:uuid this[2]
execute store result score $active ff_active_uuid_3 run data get storage fossil_frights:uuid this[3]
