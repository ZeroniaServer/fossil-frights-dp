...
execute if score $run_multiplayer ff_game_state matches 1 unless score $run_everyone_mode ff_game_state matches 1 unless score $active_online ff_game_state = $run_roster_count ff_game_state run function fossil_frights:game/handle_multiplayer_disconnect
