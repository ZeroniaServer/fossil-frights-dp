...
scoreboard players add $run_roster_count ff_game_state 1
summon minecraft:marker 0 -64 0 {Tags:["ff_run_member","ff_run_member_new"]}
scoreboard players operation @e[type=minecraft:marker,tag=ff_run_member_new,limit=1] ff_run_order = $run_roster_count ff_game_state
