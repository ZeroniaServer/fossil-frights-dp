...
execute if score $day_current ff_day matches 1 run function fossil_frights:game/speedrun/update_day1_best
execute if score $day_current ff_day matches 2 run function fossil_frights:game/speedrun/update_day2_best
execute if score $day_current ff_day matches 3 run function fossil_frights:game/speedrun/update_day3_best
execute if score $day_current ff_day matches 4 run function fossil_frights:game/speedrun/update_day4_best
execute if score $day_current ff_day matches 5 run function fossil_frights:game/speedrun/update_day5_best
execute if score $day_current ff_day matches 6 run function fossil_frights:game/speedrun/update_day6_best
execute if score $day_current ff_day matches 7 run function fossil_frights:game/speedrun/update_day7_best
