...
execute if score $game_running ff_game_state matches 1 if score $day_active ff_day matches 0 if score $day_current ff_day matches ..9 if entity @a[tag=ff_in_queue] if score $idle_ticks ff_game_state matches 3600.. run function fossil_frights:game/reset
