...
function fossil_frights:messages/multiplayer/invite_received with storage fossil_frights:invite
function fossil_frights:messages/multiplayer/invite_sent
