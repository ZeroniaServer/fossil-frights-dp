...
execute if score $time_anim_resume_cycle ff_day matches 1 run gamerule doDaylightCycle true
execute unless score $time_anim_resume_cycle ff_day matches 1 run gamerule doDaylightCycle false
