execute if score $heist_mode_active ff_game_state matches 1 run function fossil_frights:admin/menu/heists/pause_timer
...
function fossil_frights:game/timer/freeze
