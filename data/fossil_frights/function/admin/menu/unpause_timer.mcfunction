execute if score $heist_mode_active ff_game_state matches 1 run function fossil_frights:admin/menu/heists/unpause_timer
...
function fossil_frights:game/timer/start
scoreboard players set $idle_ticks ff_game_state 0
function fossil_frights:admin/menu/set_time_menu
