execute if score $loot_muddy_sherd ff_heist_loot_state matches 3 run scoreboard players operation $heist_loot ff_heist -= $loot_muddy_sherd ff_heist_loot_value
