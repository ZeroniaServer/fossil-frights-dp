...
execute unless score $game_running ff_game_state matches 1 unless entity @a[limit=1,tag=ff_active] run function fossil_frights:messages/error/no_active_player
