...
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $victory_complete ff_game_state matches 1 run return 0
execute if entity @a if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 unless score $join_pad_mode ff_game_state matches 4 run function fossil_frights:join/heists/setup
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 run scoreboard players set $join_pad_mode ff_game_state 4
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 run function fossil_frights:join/heists/show
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 as @a[x=-3,y=80,z=7,dx=2,dy=4,dz=1,gamemode=adventure,tag=!ff_fade_tp_active,scores={ff_join_cooldown=0}] run function fossil_frights:join/heists/thief_enter
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 as @a[x=0,y=80,z=7,dx=2,dy=4,dz=1,gamemode=adventure,tag=!ff_fade_tp_active,scores={ff_join_cooldown=0}] run function fossil_frights:join/heists/guard_enter
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 0 run return 0
execute if entity @a if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 unless score $join_pad_mode ff_game_state matches 2 run function fossil_frights:join/setup
execute if entity @a if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run scoreboard players set $join_pad_mode ff_game_state 2
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run function fossil_frights:join/show/queue
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run function fossil_frights:join/show/spectator
tag @e[type=minecraft:mannequin,tag=ff_queue_mannequin] remove ff_queue_owner_online
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 as @a[tag=ff_in_queue] run function fossil_frights:join/mark_queue_owner_online
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 as @e[type=minecraft:mannequin,tag=ff_queue_mannequin,tag=!ff_queue_owner_online] run function fossil_frights:join/remove_queue_stand
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 as @a[x=0,y=80,z=7,dx=2,dy=4,dz=1,gamemode=adventure,tag=!ff_fade_tp_active,scores={ff_join_cooldown=0}] run function fossil_frights:join/queue_enter
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 as @a[x=-3,y=80,z=7,dx=2,dy=4,dz=1,tag=!ff_join_spectator_zone,tag=!ff_fade_tp_active] run function fossil_frights:join/spectator_toggle
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run tag @a[tag=ff_join_spectator_zone] remove ff_join_spectator_zone
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run tag @a[x=-3,y=80,z=7,dx=2,dy=4,dz=1] add ff_join_spectator_zone
execute if score $game_running ff_game_state matches 1 if score $heist_mode_active ff_game_state matches 1 if score $heist_round_active ff_game_state matches 1 run return 0
