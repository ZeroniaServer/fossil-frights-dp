...
summon minecraft:text_display -0.875 81.0 8.0 {Tags:["ff_join_heist_label"],billboard:"center",view_range:10f,background:0,default_background:0b,see_through:0b,shadow:1b,text_opacity:255,brightness:{sky:15,block:15},text:[{"text":"ᴛʜɪᴇᴠᴇꜱ","color":"red","italic":false}]}
summon minecraft:text_display 1.75 81.0 8.0 {Tags:["ff_join_heist_label"],billboard:"center",view_range:10f,background:0,default_background:0b,see_through:0b,shadow:1b,text_opacity:255,brightness:{sky:15,block:15},text:[{"text":"ɢᴜᴀʀᴅꜱ","color":"yellow","italic":false}]}
