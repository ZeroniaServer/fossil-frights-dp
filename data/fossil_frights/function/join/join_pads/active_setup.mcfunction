...
summon minecraft:text_display 0.4375 81.0 8.0 {Tags:["ff_join_active_label"],billboard:"center",view_range:10f,background:0,default_background:0b,see_through:0b,shadow:1b,text_opacity:255,brightness:{sky:15,block:15},text:[{"translate":"ff.start_game","color":"green","italic":false}]}
