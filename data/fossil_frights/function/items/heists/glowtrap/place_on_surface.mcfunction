execute positioned ^ ^ ^-0.12 run summon minecraft:marker ~ ~ ~ {Tags:["ff_glowtrap"],CustomName:"trap"}
...
execute if entity @e[type=minecraft:marker,tag=ff_glowtrap,sort=nearest,limit=1,distance=..0.35] run playsound minecraft:block.amethyst_block.place player @a[team=ff_guard] ~ ~ ~ 0.8 1.4
