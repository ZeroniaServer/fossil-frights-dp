...
particle minecraft:soul_fire_flame ~ ~0.12 ~ 0.08 0.16 0.08 0 3 force @a[tag=ff_heist_guard]
particle minecraft:end_rod ~ ~0.12 ~ 0.05 0.08 0.05 0 1 force @a[tag=ff_heist_guard]
