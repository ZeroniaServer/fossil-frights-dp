...
tp @s ~ ~ ~ ~10 ~
execute if score @s ff_glowtrap_age matches ..39 run function fossil_frights:items/heists/glowtrap/fx_arming
execute if score @s ff_glowtrap_age matches ..39 run return 0
execute if score @s ff_glowtrap_age matches 40..49 run function fossil_frights:items/heists/glowtrap/fx_activate_expand
