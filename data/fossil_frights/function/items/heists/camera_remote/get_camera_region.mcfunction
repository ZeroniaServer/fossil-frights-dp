...
execute if score @s ff_map_region matches 15 run return run scoreboard players set @s ff_security_camera 10
execute if score @s ff_map_region matches 12 run return run scoreboard players set @s ff_security_camera 9
execute if score @s ff_map_region matches 17 run return run scoreboard players set @s ff_security_camera 8
