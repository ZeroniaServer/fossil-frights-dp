...
execute if items entity @s weapon.mainhand *[custom_data~{ff_heist_ice_cannon_remote:1b}] unless data entity @s {Inventory:[{Slot:103b}]} run function fossil_frights:items/heists/ice_cannon/equip_cannon
