...
execute positioned ~-0.35 ~-0.35 ~-0.35 if entity @a[gamemode=!spectator,tag=!ff_ice_cannon_shooter,dx=0.7,dy=0.7,dz=0.7] run function fossil_frights:items/heists/ice_cannon/impact
tp @s ^ ^ ^0.9
