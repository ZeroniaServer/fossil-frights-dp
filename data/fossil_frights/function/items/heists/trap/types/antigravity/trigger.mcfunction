...
schedule function fossil_frights:items/heists/trap/types/antigravity/fx_levitation 10t append
schedule function fossil_frights:items/heists/trap/types/antigravity/remove_fx_tag 105t append
