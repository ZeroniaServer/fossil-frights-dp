...
execute if score @s ff_glowtrap_age matches 50.. if score @s ff_glowtrap_fx matches 0 run function fossil_frights:items/heists/trap/types/glow/fx_ring
execute if score @s ff_glowtrap_age matches 50.. if score @s ff_glowtrap_fx matches 5 run function fossil_frights:items/heists/trap/types/glow/fx_ring
execute if score @s ff_glowtrap_age matches 50.. if score @s ff_glowtrap_fx matches 10 run function fossil_frights:items/heists/trap/types/glow/fx_ring
execute if score @s ff_glowtrap_age matches 50.. if score @s ff_glowtrap_fx matches 15 run function fossil_frights:items/heists/trap/types/glow/fx_ring
