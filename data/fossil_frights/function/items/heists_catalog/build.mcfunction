...
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/trap_glow",page:"page_1",slot:2}
...
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/one_time_key",page:"page_1",slot:6}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/other/cubekoin",page:"page_1",slot:7}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/coffee",page:"page_1",slot:8}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/poster_tube",page:"page_1",slot:9}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/ghast_plushie",page:"page_1",slot:10}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/piglin_head",page:"page_1",slot:11}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/popcorn",page:"page_1",slot:12}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/lollipop",page:"page_1",slot:13}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/fishing_rod",page:"page_1",slot:14}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/burger",page:"page_1",slot:15}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/chocolate_cake",page:"page_1",slot:16}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/ancient_scripture",page:"page_1",slot:17}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/chondrite",page:"page_1",slot:18}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/sand_dollar",page:"page_1",slot:19}
function fossil_frights:items/heists_catalog/from_loot {loot:"items/heists/loot/low/trilobite_fossil",page:"page_1",slot:20}
