particle minecraft:poof ^ ^ ^0.18 0.04 0.04 0.04 0.06 8 force
particle minecraft:cloud ^ ^ ^0.28 0.05 0.04 0.05 0.03 5 force
particle minecraft:firework ^ ^ ^0.45 0.04 0.04 0.04 0.04 6 force
playsound minecraft:entity.breeze.wind_burst block @a[distance=..24] ~ ~ ~ 0.8 1.35
playsound minecraft:block.dispenser.dispense block @a[distance=..18] ~ ~ ~ 0.45 1.7
