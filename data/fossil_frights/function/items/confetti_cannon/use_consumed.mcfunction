...
execute at @s run function fossil_frights:items/confetti_cannon/fire
scoreboard players add @s ff_confetti_uses 1
execute if score @s ff_confetti_uses matches 10.. run function fossil_frights:items/confetti_cannon/break_remote
