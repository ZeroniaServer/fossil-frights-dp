...
scoreboard players operation #seconds ff_dropped_item_despawn_timestamp /= #twenty ff_dropped_item_despawn_timestamp
scoreboard players operation #deciseconds ff_dropped_item_despawn_timestamp %= #twenty ff_dropped_item_despawn_timestamp
scoreboard players operation #deciseconds ff_dropped_item_despawn_timestamp *= #ten ff_dropped_item_despawn_timestamp
scoreboard players operation #deciseconds ff_dropped_item_despawn_timestamp /= #twenty ff_dropped_item_despawn_timestamp
...
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:15}} run particle minecraft:raid_omen ~ ~0.25 ~ 0.1 0 0.1 0 1 force @a[tag=ff_heist_thief]
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:15}} run particle minecraft:trial_omen ~ ~0.25 ~ 0.1 0 0.1 0 1 force @a[tag=ff_heist_guard,gamemode=!spectator]
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{periodic_tick:15}} run particle minecraft:trial_omen ~ ~0.25 ~ 0.1 0 0.1 0 1 force @a[gamemode=spectator,tag=!ff_heist_guard]
