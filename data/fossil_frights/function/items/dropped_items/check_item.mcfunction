...
execute if predicate fossil_frights:game/heist_mode_active if items entity @s contents *[custom_data~{ff_heist_loot:true}] run data modify entity @s Age set value 5600
