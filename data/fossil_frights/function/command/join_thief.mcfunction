...
execute if entity @s[tag=ff_heist_thief] run function fossil_frights:messages/error/already_on_team
execute if entity @s[tag=ff_heist_thief] run return 0
function fossil_frights:join/heists/thief_enter
