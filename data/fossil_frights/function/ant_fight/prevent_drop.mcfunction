...
data modify storage fossil_frights:nbt uuid set from entity @e[type=minecraft:item,distance=..8,limit=1,sort=nearest,predicate=fossil_frights:entity/contents/ant_leaf] Thrower
