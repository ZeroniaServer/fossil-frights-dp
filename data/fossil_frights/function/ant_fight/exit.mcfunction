...
execute if data entity @s {SelectedItem:{id:"minecraft:snowball",components:{"minecraft:custom_data":{ff_ant_leaf:1b}}}} run item replace entity @s weapon.mainhand with air
