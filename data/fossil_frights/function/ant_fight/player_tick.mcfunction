...
execute if entity @s[tag=ff_ant_fight] unless data entity @s {Inventory:[{id:"minecraft:snowball",components:{"minecraft:custom_data":{ff_ant_leaf:1b}}}]} run give @s minecraft:snowball[minecraft:item_name={text:"Infinileaf",color:"green",italic:false},minecraft:lore=[{text:"Shoot ",color:"dark_green",italic:false,extra:[{text:"- Right Click",color:"white",italic:false}]},{text:"Leave ",color:"red",italic:false,extra:[{text:"- Drop",color:"white",italic:false}]}],minecraft:use_cooldown={seconds:0.25f,cooldown_group:"fossil_frights:infinileaf"},minecraft:custom_data={ff_ant_leaf:1b}] 1
