...
execute store success score $ant_hit_valid ff_ant_fight as @e[type=minecraft:snowball,tag=ff_ant_marked,distance=..1.25,limit=1,sort=nearest] on origin run function fossil_frights:ant_fight/increment_ant_score
