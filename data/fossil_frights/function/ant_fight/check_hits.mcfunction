...
execute store success score $ant_hit_valid ff_ant_fight as @a[tag=ff_ant_fight] if score @s ff_active_uuid_0 = @e[type=minecraft:snowball,tag=ff_ant_marked,distance=..1.25,limit=1,sort=nearest] ff_ant_proj_0 if score @s ff_active_uuid_1 = @e[type=minecraft:snowball,tag=ff_ant_marked,distance=..1.25,limit=1,sort=nearest] ff_ant_proj_1 if score @s ff_active_uuid_2 = @e[type=minecraft:snowball,tag=ff_ant_marked,distance=..1.25,limit=1,sort=nearest] ff_ant_proj_2 if score @s ff_active_uuid_3 = @e[type=minecraft:snowball,tag=ff_ant_marked,distance=..1.25,limit=1,sort=nearest] ff_ant_proj_3 run scoreboard players add @s ff_ant_score 1
