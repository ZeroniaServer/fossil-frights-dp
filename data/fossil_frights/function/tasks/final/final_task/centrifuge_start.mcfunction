...
playsound minecraft:block.beacon.ambient block @a[tag=ff_active,distance=..24] -23.5 107.5 64.5 0.5 1.2
playsound minecraft:block.respawn_anchor.charge block @a[tag=ff_active,distance=..24] -23.5 107.5 64.5 0.35 1.7
