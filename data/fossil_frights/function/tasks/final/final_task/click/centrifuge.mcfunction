...
execute if score $final_task_item ff_task_state matches 4 if items entity @s weapon.mainhand *[minecraft:custom_data~{itemID:"lava_tablet"}] run function fossil_frights:tasks/final/final_task/click/centrifuge/accept/lava_tablet
...
execute if score $final_task_item ff_task_state matches 7 if items entity @s weapon.mainhand minecraft:bone_meal run function fossil_frights:tasks/final/final_task/click/centrifuge/accept/bone_meal
...
execute if score $final_task_item ff_task_state matches 10 if items entity @s weapon.mainhand minecraft:leather run function fossil_frights:tasks/final/final_task/click/centrifuge/accept/leather
