...
execute if score $final_task_dino ff_task_state matches 1 if items entity @s weapon.mainhand minecraft:paper[minecraft:lore=[{text:"",extra:["pteradactyl_dna_cloth"]}]] run function fossil_frights:tasks/final/final_task/click/dna/accept/pteradactyl
