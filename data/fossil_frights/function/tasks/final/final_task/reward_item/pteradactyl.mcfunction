function fossil_frights:items/plushies/definitions/pteradactyl
...
data modify entity @e[type=minecraft:item,tag=ff_final_reward_new,limit=1,sort=nearest] Item set from storage fossil_frights:items definitions.plushies.pteradactyl
