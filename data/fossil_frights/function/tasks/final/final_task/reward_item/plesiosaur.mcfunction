function fossil_frights:items/plushies/definitions/plesiosaur
...
data modify entity @e[type=minecraft:item,tag=ff_final_reward_new,limit=1,sort=nearest] Item set from storage fossil_frights:items definitions.plushies.plesiosaur
