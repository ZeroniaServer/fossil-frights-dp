...
playsound minecraft:block.beacon.activate block @a[team=ff_guard,distance=..28] -19.5 109.9 61.0 0.95 1.35
playsound minecraft:entity.allay.item_given player @a[team=ff_guard,distance=..28] -19.5 109.9 61.0 1 1.2
