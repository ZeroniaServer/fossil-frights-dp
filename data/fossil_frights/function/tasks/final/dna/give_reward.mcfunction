...
execute if items entity @s contents *[lore=[{text:"",extra:["pteradactyl_egg"]}]] as @a[tag=ff_dna_user,limit=1] run function fossil_frights:tasks/final/dna/give_reward/pteradactyl
