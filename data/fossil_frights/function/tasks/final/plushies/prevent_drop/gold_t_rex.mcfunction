...
execute as @a[tag=obtained_gold_t_rex_plushie] if score @s ff_active_uuid_0 = $plushie_drop ff_active_uuid_0 if score @s ff_active_uuid_1 = $plushie_drop ff_active_uuid_1 if score @s ff_active_uuid_2 = $plushie_drop ff_active_uuid_2 if score @s ff_active_uuid_3 = $plushie_drop ff_active_uuid_3 run function fossil_frights:tasks/final/plushies/give/gold_t_rex
kill @s
