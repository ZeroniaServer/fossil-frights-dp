...
execute if score $sponge_up_spill_sel ff_task_state matches 1 if score $sponge_up_spill_done ff_task_state matches 0 positioned -15.5 79.5 69.5 run playsound minecraft:block.sponge.absorb block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.15
execute if score $sponge_up_spill_sel ff_task_state matches 1 if score $sponge_up_spill_done ff_task_state matches 0 positioned -15.5 79.5 69.5 run playsound minecraft:item.bucket.fill block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.35 1.7
