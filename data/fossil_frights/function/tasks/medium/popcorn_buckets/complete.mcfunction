...
execute unless data entity @s {SelectedItem:{id:"minecraft:phantom_membrane"}} unless data entity @s {Inventory:[{Slot:-106b,id:"minecraft:phantom_membrane"}]} run return 0
...
execute if score $popcorn_buckets_sel ff_task_state matches 1 if score $popcorn_buckets_done ff_task_state matches 0 run clear @s minecraft:phantom_membrane 1
