...
execute unless data entity @s {SelectedItem:{id:"minecraft:phantom_membrane",components:{"minecraft:custom_data":{itemID:"empty_popcorn"}}}} unless data entity @s {Inventory:[{Slot:-106b,id:"minecraft:phantom_membrane",components:{"minecraft:custom_data":{itemID:"empty_popcorn"}}}]} run return 0
