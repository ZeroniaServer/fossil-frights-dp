...
execute if score $fix_sculker_sel ff_task_state matches 1 if score $fix_sculker_done ff_task_state matches 0 positioned 36.5 68.5 61.5 run playsound minecraft:block.sculk_catalyst.bloom master @a[team=ff_guard,distance=..18] ~ ~ ~ 1.0 1.0
execute if score $fix_sculker_sel ff_task_state matches 1 if score $fix_sculker_done ff_task_state matches 0 positioned 36.5 68.5 61.5 run playsound minecraft:block.sculk_sensor.clicking master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 0.85
