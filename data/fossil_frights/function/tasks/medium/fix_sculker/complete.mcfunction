...
execute if score $fix_sculker_sel ff_task_state matches 1 if score $fix_sculker_done ff_task_state matches 0 positioned 36.5 68.5 61.5 run playsound minecraft:block.sculk_catalyst.bloom master @a[tag=ff_active,distance=..18] ~ ~ ~ 1.0 1.0
execute if score $fix_sculker_sel ff_task_state matches 1 if score $fix_sculker_done ff_task_state matches 0 positioned 36.5 68.5 61.5 run playsound minecraft:block.sculk_sensor.clicking master @a[tag=ff_active,distance=..18] ~ ~ ~ 0.9 0.85
...
execute if score $fix_sculker_sel ff_task_state matches 1 if score $fix_sculker_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"fix_sculker"}] 1
