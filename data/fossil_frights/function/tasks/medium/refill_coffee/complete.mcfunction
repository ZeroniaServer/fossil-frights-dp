...
execute if score $refill_coffee_sel ff_task_state matches 1 if score $refill_coffee_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Refill Coffee"
