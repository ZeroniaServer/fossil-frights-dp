...
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:item.bucket.empty_lava block @a[team=ff_guard,distance=..20] ~ ~ ~ 0.9 1.15
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:block.lava.pop block @a[team=ff_guard,distance=..20] ~ ~ ~ 0.8 1.35
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:block.fire.ambient block @a[team=ff_guard,distance=..20] ~ ~ ~ 0.7 1.55
