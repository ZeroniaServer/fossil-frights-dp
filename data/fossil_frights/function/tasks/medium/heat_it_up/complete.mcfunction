...
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:item.bucket.empty_lava block @a[tag=ff_active,distance=..20] ~ ~ ~ 0.9 1.15
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:block.lava.pop block @a[tag=ff_active,distance=..20] ~ ~ ~ 0.8 1.35
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 positioned -23.5 103.5 12.5 run playsound minecraft:block.fire.ambient block @a[tag=ff_active,distance=..20] ~ ~ ~ 0.7 1.55
...
execute if score $heat_it_up_sel ff_task_state matches 1 if score $heat_it_up_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"heat_it_up"}] 1
