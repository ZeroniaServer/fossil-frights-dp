...
execute if score $cool_it_done ff_task_state matches 1 positioned 24.5 103.5 9.5 run playsound minecraft:block.glass.break block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.4 1.9
