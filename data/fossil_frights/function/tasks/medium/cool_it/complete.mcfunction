...
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Cool It"
...
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 positioned 23.5 103.5 9.5 run playsound minecraft:block.glass.break block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.45 1.7
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 positioned 23.5 103.5 9.5 run playsound minecraft:block.fire.extinguish block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.65 1.45
...
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"cool_it"}] 1
