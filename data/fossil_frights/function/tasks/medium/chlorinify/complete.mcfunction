...
execute if score $chlorinify_sel ff_task_state matches 1 if score $chlorinify_done ff_task_state matches 0 at @s run playsound minecraft:entity.generic.splash master @a[team=ff_guard,distance=..16] ~ ~ ~ 0.9 1.2
