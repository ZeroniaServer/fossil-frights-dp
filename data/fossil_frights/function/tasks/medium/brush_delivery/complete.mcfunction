...
playsound minecraft:item.brush.brushing_sand block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.9 1.1
...
clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"brush_delivery"}] 1
