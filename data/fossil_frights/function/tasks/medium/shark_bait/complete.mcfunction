...
execute if score $shark_bait_sel ff_task_state matches 1 if score $shark_bait_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Shark Bait"
