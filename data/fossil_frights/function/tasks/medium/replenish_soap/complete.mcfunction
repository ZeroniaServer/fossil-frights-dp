...
execute if score $replenish_soap_sel ff_task_state matches 1 if score $replenish_soap_done ff_task_state matches 0 if entity @s[type=minecraft:item] run data modify entity @e[type=minecraft:item_display,tag=ff_replenish_soap_display,sort=nearest,limit=1,x=-22.5,y=95.00,z=19.5,distance=..0.2] item set from entity @s Item
execute if score $replenish_soap_sel ff_task_state matches 1 if score $replenish_soap_done ff_task_state matches 0 if entity @s[type=minecraft:player] run data modify entity @e[type=minecraft:item_display,tag=ff_replenish_soap_display,sort=nearest,limit=1,x=-22.5,y=95.00,z=19.5,distance=..0.2] item set from entity @s SelectedItem
