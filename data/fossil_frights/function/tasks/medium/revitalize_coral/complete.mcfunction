...
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 positioned -18.5 80.5 67.5 run playsound minecraft:block.flowering_azalea.place block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.65 1.45
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 positioned -18.5 80.5 67.5 run playsound minecraft:block.coral_block.place block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.75 1.25
