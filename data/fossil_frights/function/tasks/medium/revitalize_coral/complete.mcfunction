...
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Revitalize Coral"
...
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 positioned -18.5 80.5 67.5 run playsound minecraft:block.flowering_azalea.place block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.65 1.45
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 positioned -18.5 80.5 67.5 run playsound minecraft:block.coral_block.place block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.75 1.25
...
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"revitalize_coral"}] 1
