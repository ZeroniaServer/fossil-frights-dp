...
execute if score $wash_muddy_sherd_sel ff_task_state matches 1 if score $wash_muddy_sherd_done ff_task_state matches 0 positioned 48.5 68.5 57.5 run particle minecraft:block{block_state:{Name:"minecraft:mud"}} ~ ~0.2 ~ 0.35 0.2 0.35 0.08 34 force
execute if score $wash_muddy_sherd_sel ff_task_state matches 1 if score $wash_muddy_sherd_done ff_task_state matches 0 positioned 48.5 68.5 57.5 run particle minecraft:splash ~ ~0.2 ~ 0.35 0.2 0.35 0.06 24 force
execute if score $wash_muddy_sherd_sel ff_task_state matches 1 if score $wash_muddy_sherd_done ff_task_state matches 0 positioned 48.5 68.5 57.5 run playsound minecraft:entity.generic.splash block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.8 1.2
