...
execute if score $restock_plushies_sel ff_task_state matches 1 if score $restock_plushies_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "restock_plushies"
