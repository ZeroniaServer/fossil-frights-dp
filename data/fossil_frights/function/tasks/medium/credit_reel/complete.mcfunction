...
execute if score $credit_reel_sel ff_task_state matches 1 if score $credit_reel_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"credit_reel"}] 1
