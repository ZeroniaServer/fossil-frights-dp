...
execute if score $water_crops_done ff_task_state matches 1 positioned 60.5 82 73.5 run playsound minecraft:block.crop.break block @a[team=ff_guard,distance=..22] ~ ~ ~ 0.35 1.8
