...
execute as @a[tag=ff_active,tag=!ff_fade_tp_active,x=49,y=71,z=51,dx=4,dy=1,dz=0] at @s if score $ancient_portal_timer ff_task_state matches 1.. run function fossil_frights:tasks/medium/ancient_portal/teleport_random
