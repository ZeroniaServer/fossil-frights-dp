...
execute if score $run_multiplayer ff_game_state matches 1 as @a[tag=ff_title_first,limit=1] run data modify storage fossil_frights:tasks tracker_title.name1 set from entity @s bukkit.lastKnownName
execute if score $run_multiplayer ff_game_state matches 1 as @a[tag=ff_active,tag=!ff_title_first,limit=1] run data modify storage fossil_frights:tasks tracker_title.name2 set from entity @s bukkit.lastKnownName
...
execute if score $run_multiplayer ff_game_state matches 0 as @a[tag=ff_active,limit=1] run data modify storage fossil_frights:tasks tracker_title.name set from entity @s bukkit.lastKnownName
