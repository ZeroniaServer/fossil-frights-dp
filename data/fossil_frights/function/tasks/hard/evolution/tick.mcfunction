execute as @e[type=minecraft:mannequin,tag=ff_evolution_4,limit=1] at @e[type=minecraft:ocelot,tag=ff_evolution_4,limit=1,sort=nearest] run tp @s ~ ~ ~ ~ 0
execute as @e[type=minecraft:mannequin,tag=ff_evolution_3,limit=1] at @e[type=minecraft:ocelot,tag=ff_evolution_3,limit=1,sort=nearest] run tp @s ~ ~ ~ ~ 0
execute as @e[type=minecraft:mannequin,tag=ff_evolution_2,limit=1] at @e[type=minecraft:ocelot,tag=ff_evolution_2,limit=1,sort=nearest] run tp @s ~ ~ ~ ~ 0
execute as @e[type=minecraft:mannequin,tag=ff_evolution_1,limit=1] at @e[type=minecraft:ocelot,tag=ff_evolution_1,limit=1,sort=nearest] run tp @s ~ ~ ~ ~ 0
