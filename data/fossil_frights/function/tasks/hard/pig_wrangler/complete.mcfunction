...
execute positioned 71.5 80.5 41.5 run playsound minecraft:entity.pig.ambient block @a[team=ff_guard,distance=..18] ~ ~ ~ 1.0 1.1
execute positioned 71.5 80.5 41.5 run playsound minecraft:entity.player.levelup master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.6 1.5
