...
data modify storage fossil_frights:tasks complete.task_name set value "Pig Wrangler"
execute positioned 71.5 80.5 41.5 run playsound minecraft:entity.pig.ambient block @a[tag=ff_active,distance=..18] ~ ~ ~ 1.0 1.1
execute positioned 71.5 80.5 41.5 run playsound minecraft:entity.player.levelup master @a[tag=ff_active,distance=..18] ~ ~ ~ 0.6 1.5
...
clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"pig_wrangler"}] 1
