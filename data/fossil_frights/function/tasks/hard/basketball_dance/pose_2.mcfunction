setblock -26 81 34 minecraft:waxed_oxidized_copper_golem_statue[copper_golem_pose=sitting,facing=east] strict
...
execute positioned -26.0 81.0 34.0 run data modify entity @e[limit=1,distance=..0.01,type=minecraft:block_display,tag=ff_coppy_the_copper_golem] block_state.Properties.copper_golem_pose set value "sitting"
