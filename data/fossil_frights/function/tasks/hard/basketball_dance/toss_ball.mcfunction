...
execute positioned -25.0 81.35 34.5 run function fossil_frights:util/summon_item {nbt:{PickupDelay:10,Motion:[0.22d,0.18d,0.0d]},loot_table:"fossil_frights:items/other/basketball"}
