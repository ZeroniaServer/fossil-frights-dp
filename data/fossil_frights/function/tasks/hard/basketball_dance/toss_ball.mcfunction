...
function fossil_frights:items/task_rewards/definitions/basketball
...
data modify entity @e[type=minecraft:item,tag=ff_basketball_dance_toss,limit=1,sort=nearest] Item set from storage fossil_frights:items definitions.task_rewards.basketball
