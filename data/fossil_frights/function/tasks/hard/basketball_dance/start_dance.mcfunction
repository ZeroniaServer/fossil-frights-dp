...
execute positioned -23.5 80.8 32.5 run playsound minecraft:block.note_block.bass master @a[tag=ff_active,distance=..20] ~ ~ ~ 0.9 1.1
execute positioned -23.5 80.8 32.5 run playsound minecraft:block.note_block.chime master @a[tag=ff_active,distance=..20] ~ ~ ~ 0.6 1.5
