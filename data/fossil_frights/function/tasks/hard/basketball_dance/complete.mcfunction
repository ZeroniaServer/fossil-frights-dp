...
execute if score $basketball_dance_sel ff_task_state matches 1 if score $basketball_dance_done ff_task_state matches 0 positioned 40.5 83.5 34.5 run playsound minecraft:block.note_block.pling master @a[tag=ff_active,distance=..24] ~ ~ ~ 1.0 1.6
execute if score $basketball_dance_sel ff_task_state matches 1 if score $basketball_dance_done ff_task_state matches 0 positioned 40.5 83.5 34.5 run playsound minecraft:entity.experience_orb.pickup master @a[tag=ff_active,distance=..24] ~ ~ ~ 0.8 1.4
...
execute if score $basketball_dance_sel ff_task_state matches 1 if score $basketball_dance_done ff_task_state matches 0 run clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"basketball_dance"}] 1
