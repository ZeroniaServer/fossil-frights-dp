...
execute if score $glowberry_tree_1_watered ff_task_state matches 1 run return 0
execute unless entity @e[limit=1,tag=ff_glowberry_tree_1_potion,x=10,y=80,z=38,dx=4,dy=2,dz=4] run function fossil_frights:tasks/hard/glowberry_trees/tree_1/pending_clear
