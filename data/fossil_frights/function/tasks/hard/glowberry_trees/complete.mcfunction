...
data modify storage fossil_frights:tasks complete.task_name set value "Glowberry Trees"
...
clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"glowberry_trees"}] 1
