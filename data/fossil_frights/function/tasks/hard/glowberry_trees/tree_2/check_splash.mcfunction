...
execute if entity @e[tag=ff_glowberry_tree_2_potion,x=-14,y=80,z=38,dx=4,dy=2,dz=4] run schedule function fossil_frights:tasks/hard/glowberry_trees/tree_2/check_splash 5t
