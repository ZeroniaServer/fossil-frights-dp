...
execute if score $glowberry_tree_2_watered ff_task_state matches 1 run return 0
execute unless entity @e[tag=ff_glowberry_tree_2_potion,x=-13,y=81,z=39,dx=2,dy=1,dz=2] run function fossil_frights:tasks/hard/glowberry_trees/tree_2/pending_clear
execute if entity @e[tag=ff_glowberry_tree_2_potion,x=-13,y=81,z=39,dx=2,dy=1,dz=2] run schedule function fossil_frights:tasks/hard/glowberry_trees/tree_2/check_splash 5t
