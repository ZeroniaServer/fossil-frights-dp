...
execute unless items entity @s weapon.mainhand minecraft:ominous_trial_key unless items entity @s weapon.offhand minecraft:ominous_trial_key run return 0
execute if score $return_the_key_sel ff_task_state matches 1 if score $return_the_key_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Return the Key"
...
execute if score $return_the_key_sel ff_task_state matches 1 if score $return_the_key_done ff_task_state matches 0 run clear @s minecraft:ominous_trial_key
