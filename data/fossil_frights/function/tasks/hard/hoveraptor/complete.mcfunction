...
execute positioned 21.5 104.5 42.5 run playsound minecraft:entity.breeze.idle_air master @a[tag=ff_active,distance=..24] ~ ~ ~ 0.8 1.25
...
clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"hoveraptor"}] 1
