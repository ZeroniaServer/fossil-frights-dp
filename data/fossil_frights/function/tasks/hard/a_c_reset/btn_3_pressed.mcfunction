...
execute positioned 8 108 57 run playsound minecraft:entity.player.hurt_freeze block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.7 1.4
execute positioned 8 108 57 run playsound minecraft:block.powder_snow.break block @a[tag=ff_active,distance=..18] ~ ~ ~ 0.6 1.2
