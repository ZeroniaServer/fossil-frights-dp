...
summon item 18 72 29 {Tags:["ff_task_book_temp"],PickupDelay:32767,Age:-32768,Item:{id:"minecraft:written_book",count:1,components:{"minecraft:item_name":{text:"Hard Task 10",italic:false},"minecraft:custom_data":{ff_task_book:"hard_task_10"}}}}
