...
execute if score $bathroom_leak_sel ff_task_state matches 1 if score $bathroom_leak_done ff_task_state matches 0 as @a[tag=ff_active] at @s run playsound minecraft:entity.generic.splash master @s ~ ~ ~ 0.9 1.2
