...
execute if score $dive_into_well_sel ff_task_state matches 1 if score $dive_into_well_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Dive into Well"
