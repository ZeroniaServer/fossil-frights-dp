...
execute if score $reset_salt_level_sel ff_task_state matches 1 if score $reset_salt_level_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 0.7 0.8
