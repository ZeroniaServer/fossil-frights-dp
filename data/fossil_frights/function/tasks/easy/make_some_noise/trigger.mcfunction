...
execute positioned 61 72 71 if entity @a[tag=ff_active,gamemode=!spectator,distance=..10,limit=1] run function fossil_frights:tasks/easy/make_some_noise/complete
