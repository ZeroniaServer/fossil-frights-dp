...
execute if score $count_shells_sel ff_task_state matches 1 if score $count_shells_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound minecraft:block.conduit.ambient.short master @s ~ ~ ~ 0.8 1.4
