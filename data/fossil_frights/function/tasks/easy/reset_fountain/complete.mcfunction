...
execute if score $reset_fountain_sel ff_task_state matches 1 if score $reset_fountain_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound minecraft:block.bubble_column.upwards_inside master @s ~ ~ ~ 0.7 1.4
