...
execute if score $security_camera_sel ff_task_state matches 1 if score $security_camera_done ff_task_state matches 0 if entity @s[type=minecraft:player] run clear @s minecraft:written_book[minecraft:custom_data~{ff_task_book:"check_security"}] 1
