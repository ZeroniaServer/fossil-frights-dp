...
execute if score $polish_bell_sel ff_task_state matches 1 if score $polish_bell_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound minecraft:block.bell.use master @s ~ ~ ~ 0.9 1.25
