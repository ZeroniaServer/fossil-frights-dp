...
execute if score $sweep_popcorn_sel ff_task_state matches 1 if score $sweep_popcorn_done ff_task_state matches 0 positioned 10 69 69 run playsound minecraft:block.grass.break master @a[team=ff_guard,distance=..12] ~ ~ ~ 0.8 1.4
