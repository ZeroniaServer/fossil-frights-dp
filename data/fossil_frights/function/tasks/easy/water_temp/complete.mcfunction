...
execute if score $water_temp_sel ff_task_state matches 1 if score $water_temp_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "water_temp"
