...
execute if score $toilet_clog_sel ff_task_state matches 1 if score $toilet_clog_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "Toilet Clog"
