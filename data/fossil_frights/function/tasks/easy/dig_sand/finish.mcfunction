...
playsound minecraft:block.sand.place master @a[tag=ff_active,distance=..14] 35 76.8 74.5 0.75 1.25
...
clear @a[tag=ff_active] minecraft:written_book[minecraft:custom_data~{ff_task_book:"dig_sand"}] 1
