...
summon cave_spider -3.5 74.7 22.5 {active_effects:[{id:"invisibility",duration:-1,show_particles:false}],Silent:1b,NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["security_camera","security_camera_7"],Team:"ff_security_camera",Invulnerable:1b,Rotation:[26F,20F],attributes:[{id:"scale",base:0.0625}]}
...
summon cave_spider 33.8 86.00 48.5 {active_effects:[{id:"invisibility",duration:-1,show_particles:false}],Silent:1b,NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["security_camera","security_camera_10"],Team:"ff_security_camera",Invulnerable:1b,Rotation:[-90F,10F],attributes:[{id:"scale",base:0.0625}]}
