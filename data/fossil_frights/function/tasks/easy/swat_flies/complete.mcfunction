...
execute if score $swat_flies_sel ff_task_state matches 1 if score $swat_flies_done ff_task_state matches 0 at @s run playsound minecraft:entity.player.attack.sweep master @a[team=ff_guard,distance=..12] ~ ~ ~ 0.8 1.3
execute if score $swat_flies_sel ff_task_state matches 1 if score $swat_flies_done ff_task_state matches 0 positioned 0.5 95.6 52.5 run playsound minecraft:entity.bee.hurt master @a[team=ff_guard,distance=..12] ~ ~ ~ 0.5 1.6
