...
execute if score $fire_pottery_sel ff_task_state matches 1 if score $fire_pottery_done ff_task_state matches 0 if entity @s[type=minecraft:player] run clear @s minecraft:written_book[minecraft:custom_data~{ff_task_book:"fire_pottery"}] 1
