...
execute if score $easy_task_4_sel ff_task_state matches 1 if score $easy_task_4_done ff_task_state matches 0 if entity @s[type=minecraft:player] run clear @s minecraft:written_book[minecraft:custom_data~{ff_task_book:"easy_task_4"}] 1
