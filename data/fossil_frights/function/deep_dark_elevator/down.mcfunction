...
schedule clear fossil_frights:deep_dark_elevator/up
...
execute if score $step ff_deep_dark_elevator matches 1.. run return run schedule function fossil_frights:deep_dark_elevator/down 1t
