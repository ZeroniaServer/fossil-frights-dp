...
execute as @e[limit=1,type=minecraft:item_display,tag=ff_deep_dark_elevator] run function fossil_frights:deep_dark_elevator/set_height_macro with storage fossil_frights:deep_dark_elevator args
...
execute if score $pitched_sound_cooldown ff_deep_dark_elevator matches 0 at @e[limit=1,type=minecraft:item_display,tag=ff_deep_dark_elevator] run function fossil_frights:deep_dark_elevator/play_pitched_sound with storage fossil_frights:deep_dark_elevator args
