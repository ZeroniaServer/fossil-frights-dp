...
kill @e[type=minecraft:interaction,tag=ff_seasonal_confetti_socials_click]
...
summon minecraft:interaction 8.50 76.0 -20.50 {width:1.0f,height:1.0f,response:1b,Tags:["ff_seasonal_confetti_socials_click"]}
