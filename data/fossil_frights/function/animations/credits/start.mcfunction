...
summon minecraft:item_display 26 78.6 75.0 {Tags:["ff_credits","ff_credits_reel","credits"],brightness:{sky:15,block:15},item_display:"fixed",item:{id:"minecraft:structure_void",count:1,components:{"minecraft:item_name":{text:"Credit Reel",italic:false},"minecraft:lore":[{text:"",extra:["credit_reel"]}],"minecraft:tooltip_display":{hidden_components:["minecraft:lore"]}}},transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.5f,0.5f,0.5f]}}
