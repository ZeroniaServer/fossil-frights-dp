...
schedule clear fossil_frights:animations/deep_dark_elevator/down
...
execute if score $step ff_deep_dark_elevator < $duration_ticks ff_deep_dark_elevator run return run schedule function fossil_frights:animations/deep_dark_elevator/up 1t
function fossil_frights:animations/deep_dark_elevator/stopped_moving
schedule function fossil_frights:animations/deep_dark_elevator/down 60t
