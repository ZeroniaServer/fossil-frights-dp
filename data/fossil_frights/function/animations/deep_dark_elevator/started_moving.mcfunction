...
execute at @e[limit=1,type=minecraft:item_display,tag=ff_deep_dark_elevator] positioned ~-0.5 ~1 ~-0.5 as @a[dx=0,predicate=fossil_frights:entity/on_ground] run tag @s add ff_deep_dark_elevator.passenger
