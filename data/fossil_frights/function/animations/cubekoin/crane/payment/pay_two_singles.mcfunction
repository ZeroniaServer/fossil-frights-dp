...
execute positioned 52 68 60 run kill @e[type=minecraft:item,distance=..1.5,predicate=fossil_frights:entity/contents/cubekoin,predicate=fossil_frights:entity/contents/count/1,tag=!ff_crane_payment_candidate,sort=nearest,limit=1]
