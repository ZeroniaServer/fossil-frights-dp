execute positioned 52 68 60 run kill @e[type=minecraft:item,distance=..1.5,predicate=fossil_frights:entity/contents/cubekoin,predicate=fossil_frights:entity/contents/count/2,sort=nearest,limit=1]
