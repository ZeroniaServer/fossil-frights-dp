...
execute positioned 52 68 60 run tellraw @p[tag=ff_active,distance=..3,sort=nearest,limit=1] ["<",{"color":"dark_aqua","text":"Sculkadillo"},"> Thanks for the ",{"color":"gold","text":"2 CubeKoins "},{"atlas":"blocks","sprite":"fossil-frights:custom/general_items/cubekoin"},",  Now hurry, you have ",{"color":"red","text":"5 seconds"}," to ride the pulley"]
