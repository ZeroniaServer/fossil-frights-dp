...
execute if score $crane_wait ff_game_state matches 0 unless entity @a[tag=ff_crane_rider,limit=1] run function fossil_frights:animations/cubekoin/crane/sculkadillo_default
