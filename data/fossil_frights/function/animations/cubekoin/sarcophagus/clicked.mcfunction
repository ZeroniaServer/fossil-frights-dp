...
execute if score #sarcophagus_coin_count ff_game_state matches ..0 if score @s ff_msg_cooldown matches 0 run title @s actionbar [{"text":"1 ","color":"yellow"},{"atlas":"blocks","sprite":"fossil-frights:custom/general_items/cubekoin"},{"text":" CubeKoin ","color":"yellow"},{"text":"Required","color":"red"}]
