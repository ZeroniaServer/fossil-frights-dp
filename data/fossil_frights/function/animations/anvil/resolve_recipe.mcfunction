...
execute if items entity @e[type=minecraft:item_display,tag=ff_anvil_display,distance=..1.5,limit=1,sort=nearest] contents *[minecraft:custom_data~{itemID:"scrap_metal"}] run function fossil_frights:animations/anvil/recipe/scrap_metal
