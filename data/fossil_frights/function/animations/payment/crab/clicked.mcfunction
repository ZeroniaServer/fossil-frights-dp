...
execute store result score #crab_coin_count ff_game_state run clear @s *[minecraft:custom_data~{itemID:"cubekoin"}] 0
...
clear @s *[minecraft:custom_data~{itemID:"cubekoin"}] 2
