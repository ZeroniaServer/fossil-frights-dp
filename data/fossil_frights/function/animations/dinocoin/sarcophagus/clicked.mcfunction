...
execute if score #sarcophagus_coin_count ff_game_state matches ..0 if score @s ff_msg_cooldown matches 0 run function fossil_frights:messages/dinocoin/crab/required_1
