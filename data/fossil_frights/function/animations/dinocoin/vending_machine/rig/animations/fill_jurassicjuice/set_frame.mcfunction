...
execute at @s run function fossil_frights:animations/dinocoin/vending_machine/rig/animations/fill_jurassicjuice/zzz/set_frame with storage fossil_frights:vending_machine_aj_temp args