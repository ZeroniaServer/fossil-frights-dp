...
execute if score #vending_owned ff_hazard_rng matches 3 run return run function fossil_frights:animations/dinocoin/vending_machine/roll_heist_any
execute store result score #vending_roll ff_hazard_rng run random value 1..3
execute if score #vending_roll ff_hazard_rng matches 1 if predicate fossil_frights:player/inventory/drinks/veloci_tea run return run function fossil_frights:animations/dinocoin/vending_machine/roll_heist
...
execute if score #vending_roll ff_hazard_rng matches 2 if predicate fossil_frights:player/inventory/drinks/raptor_rush run return run function fossil_frights:animations/dinocoin/vending_machine/roll_heist
...
execute if score #vending_roll ff_hazard_rng matches 3 if predicate fossil_frights:player/inventory/drinks/bubbly_bat run return run function fossil_frights:animations/dinocoin/vending_machine/roll_heist
