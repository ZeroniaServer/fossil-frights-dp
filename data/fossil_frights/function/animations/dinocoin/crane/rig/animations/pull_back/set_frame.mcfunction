...
execute at @s run function fossil_frights:animations/dinocoin/crane/rig/animations/pull_back/zzz/set_frame with storage fossil_frights:vending_machine_aj_temp args