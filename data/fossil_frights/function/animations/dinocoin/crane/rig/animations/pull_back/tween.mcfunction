...
$scoreboard players set @s aj.pull_back.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function fossil_frights:animations/dinocoin/crane/rig/animations/pull_back/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/dinocoin/crane/rig/animations/pull_back/zzz/apply_frame {frame: $(to_frame)}
