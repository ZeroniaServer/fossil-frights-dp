...
execute positioned 52 68 60 run kill @e[type=minecraft:item,distance=..2,nbt={Item:{id:"minecraft:gold_ingot",count:1}},tag=!ff_crane_payment_candidate,sort=nearest,limit=1]
