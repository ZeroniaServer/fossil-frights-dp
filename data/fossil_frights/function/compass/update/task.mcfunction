...
execute at @s as @e[type=minecraft:armor_stand,tag=ff_task_compass_target,sort=nearest,limit=1] run function fossil_frights:compass/update/set_task_from_marker
