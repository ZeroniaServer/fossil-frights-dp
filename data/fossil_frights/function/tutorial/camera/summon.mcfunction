...
execute at @s run summon minecraft:text_display ~ ~ ~ {Tags:["ff_tutorial_camera","ff_tutorial_camera_current","ff_tutorial_camera_new"],teleport_duration:0,interpolation_duration:0,billboard:"fixed",text:"",text_opacity:0b,background:0,default_background:0b,shadow:0b,see_through:1b}
