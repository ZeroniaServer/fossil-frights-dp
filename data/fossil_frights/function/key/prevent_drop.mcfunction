...
execute if score @s ff_key_cooldown matches 1.. run function fossil_frights:key/put_cooldown_in_hand with storage fossil_frights:key
execute unless score @s ff_key_cooldown matches 1.. run function fossil_frights:key/put_active_in_hand with storage fossil_frights:key
