...
execute if entity @s[tag=ff_map_claimed] run title @s actionbar {"translate":"ff.map_claimed","color":"red","italic":false}
execute if entity @s[tag=ff_map_claimed] run return 0
give @s minecraft:paper[minecraft:item_name={"translate":"ff.map.foyer",color:"gold",italic:false},minecraft:custom_model_data={floats:[1]},minecraft:max_stack_size=1,minecraft:custom_data={ff_museum_map_dynamic:1b,ff_museum_map_region:1}] 1
