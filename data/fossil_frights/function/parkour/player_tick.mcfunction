execute if score @s ff_parkour_running matches 0 positioned -18 75 -21 if entity @s[dx=0,dy=1,dz=0] if block ~ ~ ~ minecraft:light_weighted_pressure_plate[power=1] run function fossil_frights:parkour/start
...
execute if score @s ff_parkour_running matches 1 positioned -36 95 -43 if entity @s[dx=0,dy=1,dz=0] if block ~ ~ ~ minecraft:light_weighted_pressure_plate run function fossil_frights:parkour/finish
