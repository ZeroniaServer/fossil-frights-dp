...
data modify storage fossil_frights:chorus_cola calc.marker_entry.data.tag set from storage fossil_frights:chorus_cola calc.entity_data.data.ff_chorus_cola_indicator.tag
...
function fossil_frights:items/chorus_cola/editor/save_all/append_marker_entry with storage fossil_frights:chorus_cola calc
kill @s
