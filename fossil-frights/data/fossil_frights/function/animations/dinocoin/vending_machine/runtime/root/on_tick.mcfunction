...
function fossil_frights:animations/dinocoin/vending_machine/runtime/root/run_project_tick with storage fossil_frights:vending_machine_aj_temp entry.data