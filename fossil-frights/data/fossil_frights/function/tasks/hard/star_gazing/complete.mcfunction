...
execute if score $star_gazing_sel ff_task_state matches 1 if score $star_gazing_done ff_task_state matches 0 if entity @s[type=minecraft:player] run clear @s minecraft:written_book[minecraft:custom_data~{ff_task_book:"star_gazing"}] 1
execute if score $star_gazing_sel ff_task_state matches 1 run scoreboard players set $star_gazing_done ff_task_state 1
