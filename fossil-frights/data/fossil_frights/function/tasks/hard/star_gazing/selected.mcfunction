...
execute if score $star_gazing_sel ff_task_state matches 0 run loot insert 18 71 29 loot fossil_frights:items/task_books/hard/star_gazing
...
execute store result score $star_gazing_rotation ff_task_state run random value 1..3
