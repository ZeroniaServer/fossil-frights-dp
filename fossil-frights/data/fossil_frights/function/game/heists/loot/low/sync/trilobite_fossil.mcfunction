...
execute if score $loot_trilobite_fossil ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_trilobite_fossil_click,limit=1] run function fossil_frights:game/heists/loot/low/spawn/trilobite_fossil
