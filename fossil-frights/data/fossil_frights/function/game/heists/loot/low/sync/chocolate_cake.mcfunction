...
execute if score $loot_chocolate_cake ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_chocolate_cake_click,limit=1] run function fossil_frights:game/heists/loot/low/spawn/chocolate_cake
