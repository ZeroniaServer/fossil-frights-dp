...
execute as @a[tag=!ff_invite_self] run function fossil_frights:game/settings/multiplayer/gui/add_entry
...
function fossil_frights:game/settings/multiplayer/gui/show with storage fossil_frights:invite
