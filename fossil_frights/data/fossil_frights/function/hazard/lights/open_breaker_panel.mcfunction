...
execute unless entity @e[type=minecraft:interaction,tag=ff_lights_breaker_click,limit=1] run summon minecraft:interaction -26.0 71.5 21.5 {width:1.0f,height:1.0f,response:true,Tags:["ff_lights_breaker_click"]}
