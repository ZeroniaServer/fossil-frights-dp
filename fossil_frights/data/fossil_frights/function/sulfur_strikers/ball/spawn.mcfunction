...
function fossil_frights:sulfur_strikers/ball/random_type
function fossil_frights:sulfur_strikers/ball/random_size
execute positioned 62 70 -76 run particle minecraft:poof ~ ~0.5 ~ 0.35 0.35 0.35 0.02 24 force
function fossil_frights:sulfur_strikers/ball/summon_macro with storage fossil_frights:sulfur_strikers ball
