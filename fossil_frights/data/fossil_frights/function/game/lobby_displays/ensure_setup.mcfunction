...
function fossil_frights:game/start_room/settings/spectators/setup
function fossil_frights:game/start_room/settings/spectators/refresh
function fossil_frights:game/start_room/settings/music/setup
...
function fossil_frights:game/start_room/settings/chat/setup
function fossil_frights:game/start_room/settings/chat/refresh
function fossil_frights:game/start_room/settings/speedrun/setup
...
execute unless entity @e[type=minecraft:text_display,tag=ff_spectators_label,limit=1] run scoreboard players set $lobby_displays_ready ff_game_state 0
execute unless entity @e[type=minecraft:text_display,tag=ff_music_label,limit=1] run scoreboard players set $lobby_displays_ready ff_game_state 0
...
execute unless entity @e[type=minecraft:text_display,tag=ff_chat_label,limit=1] run scoreboard players set $lobby_displays_ready ff_game_state 0
execute unless entity @e[type=minecraft:text_display,tag=ff_speedrun_label,limit=1] run scoreboard players set $lobby_displays_ready ff_game_state 0
