...
execute unless entity @e[type=minecraft:interaction,tag=ff_heist_waiting_text_click,limit=1] run summon minecraft:interaction -1.0 110.48 53.05 {width:3.0,height:0.8,response:true,Tags:["ff_heist_waiting_text_click"]}
