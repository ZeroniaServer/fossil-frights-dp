...
execute if score $heist_round_active ff_game_state matches 0 unless entity @a[team=ff_guard] unless entity @a[team=ff_thief] run return run function fossil_frights:game/reset
