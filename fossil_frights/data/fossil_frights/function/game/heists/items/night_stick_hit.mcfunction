advancement revoke @s only fossil_frights:misc/heists_night_stick_hit
...
execute unless items entity @s weapon.mainhand *[custom_data~{itemID:"night_stick"}] run return 0
