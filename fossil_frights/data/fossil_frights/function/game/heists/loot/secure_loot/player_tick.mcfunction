...
execute if score @s ff_heist_loot_security_phase matches 3 if score @s ff_heist_loot_security_ticks matches 60.. at @s as @e[type=minecraft:interaction,tag=ff_heist_loot_security_active,distance=..6,limit=1] run function fossil_frights:game/heists/loot/secure_loot/complete_guard_heavy
...
execute if score @s ff_heist_loot_security_phase matches 4 if score @s ff_heist_loot_security_ticks matches 80.. at @s as @e[type=minecraft:interaction,tag=ff_heist_loot_security_active,distance=..6,limit=1] run function fossil_frights:game/heists/loot/secure_loot/complete_thief_heavy
