...
execute if score $loot_raptor_skull ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_raptor_skull_click,limit=1] run function fossil_frights:game/heists/loot/heavy/spawn/raptor_skull
