...
execute if score $loot_treasure_chest ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_treasure_chest_click,limit=1] run function fossil_frights:game/heists/loot/heavy/spawn/treasure_chest
