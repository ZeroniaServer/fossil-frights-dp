...
execute at @s as @e[type=minecraft:item,distance=..3,sort=nearest,limit=1] if items entity @s contents *[custom_data~{itemID:"lady_bug"}] run function fossil_frights:game/heists/loot/high/pickup/lady_bug/drop_item
