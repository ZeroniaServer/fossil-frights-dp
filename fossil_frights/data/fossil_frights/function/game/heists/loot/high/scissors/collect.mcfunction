...
execute as @e[type=minecraft:interaction,tag=ff_heist_loot_misplaced_scissors_click,distance=..10,sort=nearest,limit=1] at @s run function fossil_frights:game/heists/loot/high/scissors/announce
