...
execute positioned -24.9375 95.0 77.5 rotated 90 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/lock",nbt:{Tags:["ff_lock","ff_lock_east","ff_lock_lady_bug"],item_display:"fixed",transformation:{right_rotation:[0,0,0,1],left_rotation:[0,0,0,1],translation:[0,0.5,0],scale:[0.5,0.5,0.5]}}}
