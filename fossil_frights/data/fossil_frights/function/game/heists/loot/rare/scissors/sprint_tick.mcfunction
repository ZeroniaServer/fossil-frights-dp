...
execute if predicate fossil_frights:player/inventory/misplaced_scissors if predicate fossil_frights:player/is_sprinting run title @s actionbar {translate:"ff.heists.scissors.unsafe_to_run",color:"red",italic:false}
