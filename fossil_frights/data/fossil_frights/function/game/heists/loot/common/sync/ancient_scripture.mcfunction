...
execute if score $loot_ancient_scripture ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_ancient_scripture_click,limit=1] run function fossil_frights:game/heists/loot/common/spawn/ancient_scripture
