...
execute if score $loot_portal_core ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_portal_core_click,limit=1] run function fossil_frights:game/heists/loot/common/spawn/portal_core
