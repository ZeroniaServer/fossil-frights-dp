...
execute if score $loot_fishing_rod ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_fishing_rod_click,limit=1] run function fossil_frights:game/heists/loot/common/spawn/fishing_rod
