...
execute if score $loot_lollipop ff_heist_loot_state matches 1 unless entity @e[type=minecraft:interaction,tag=ff_heist_loot_lollipop_click,limit=1] run function fossil_frights:game/heists/loot/common/spawn/lollipop
