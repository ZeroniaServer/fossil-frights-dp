...
execute as @a[tag=ff_heist_stat_thief] if score @s ff_heist_loot_captured_round = $heist_loot_captured_round_max ff_heist_loot_captured_round run tag @s add ff_heist_stat_winner
