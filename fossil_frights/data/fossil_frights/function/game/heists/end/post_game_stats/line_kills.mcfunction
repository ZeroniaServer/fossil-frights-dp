...
execute as @a[tag=ff_heist_stat_guard] if score @s ff_heist_thieves_killed_round = $heist_thieves_killed_round_max ff_heist_thieves_killed_round run tag @s add ff_heist_stat_winner
