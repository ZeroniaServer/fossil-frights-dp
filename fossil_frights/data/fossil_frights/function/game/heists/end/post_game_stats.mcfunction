...
execute as @a[team=ff_thief] if score @s ff_heist_loot_captured_round > $heist_loot_captured_round_max ff_heist_loot_captured_round run scoreboard players operation $heist_loot_captured_round_max ff_heist_loot_captured_round = @s ff_heist_loot_captured_round
...
execute as @a[team=ff_thief] if score @s ff_heist_keys_stolen_round > $heist_keys_stolen_round_max ff_heist_keys_stolen_round run scoreboard players operation $heist_keys_stolen_round_max ff_heist_keys_stolen_round = @s ff_heist_keys_stolen_round
...
execute as @a[team=ff_guard] if score @s ff_heist_deaths_round > $heist_deaths_round_max ff_heist_deaths_round run scoreboard players operation $heist_deaths_round_max ff_heist_deaths_round = @s ff_heist_deaths_round
execute as @a[team=ff_thief] if score @s ff_heist_deaths_round > $heist_deaths_round_max ff_heist_deaths_round run scoreboard players operation $heist_deaths_round_max ff_heist_deaths_round = @s ff_heist_deaths_round
...
execute as @a[team=ff_guard] if score @s ff_heist_thieves_killed_round > $heist_thieves_killed_round_max ff_heist_thieves_killed_round run scoreboard players operation $heist_thieves_killed_round_max ff_heist_thieves_killed_round = @s ff_heist_thieves_killed_round
