...
execute if predicate fossil_frights:game_state/game_running if score $day_active ff_day matches 1 if score $timer_frozen ff_day matches 0 if score $day_timer ff_day matches ..5999 run scoreboard players add $day_timer ff_day 1
