summon minecraft:text_display ~ ~2.4 ~ {Tags:["ff_rejoin_display","ff_rejoin_display_new"],billboard:"center",see_through:true,background:0,text:{"translate":"ff.rejoin.countdown","color":"gray","with":[{"text":"2:00"}]}}
