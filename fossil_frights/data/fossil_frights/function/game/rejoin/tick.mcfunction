...
execute if predicate fossil_frights:game_state/heist_mode_active if score $heist_round_active ff_game_state matches 1 as @a[team=ff_guard] run function fossil_frights:game/rejoin/state/match_online
execute if predicate fossil_frights:game_state/heist_mode_active if score $heist_round_active ff_game_state matches 1 as @a[team=ff_thief] run function fossil_frights:game/rejoin/state/match_online
