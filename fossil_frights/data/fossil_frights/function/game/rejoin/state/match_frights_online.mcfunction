...
execute if entity @e[type=minecraft:marker,tag=ff_run_member,tag=ff_rejoin_frights_roster_match] run function fossil_frights:game/rejoin/state/match_online
tag @e[type=minecraft:marker,tag=ff_run_member] remove ff_rejoin_frights_roster_match
