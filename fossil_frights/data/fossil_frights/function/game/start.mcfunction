...
tag @a[team=ff_guard] remove ff_plushie_restore_queued
execute as @a[team=ff_guard] run function fossil_frights:items/plushies/clear_items
...
function fossil_frights:run_breakdown/start
