...
execute if score $run_multiplayer ff_game_state matches 1 unless predicate fossil_frights:game_state/party_mode_active unless score $active_online ff_game_state = $party_member_count ff_game_state run function fossil_frights:game/reset/multiplayer_disconnect
