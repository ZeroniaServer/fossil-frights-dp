...
data modify entity @e[type=minecraft:text_display,tag=ff_settings_music_label,limit=1] text set value [{text:"ᴍᴜsɪᴄ",color:"green"}]
execute if entity @a[team=ff_guard,tag=ff_settings_music_off,limit=1] run data modify entity @e[type=minecraft:text_display,tag=ff_settings_music_label,limit=1] text set value [{text:"ᴍᴜsɪᴄ",color:"red"}]
...
data modify entity @e[type=minecraft:text_display,tag=ff_settings_spectators_label,limit=1] text set value [{text:"sᴘᴇᴄᴛᴀᴛᴏʀs",color:"green"}]
execute if entity @a[team=ff_guard,tag=ff_settings_spectator_deny,limit=1] run data modify entity @e[type=minecraft:text_display,tag=ff_settings_spectators_label,limit=1] text set value [{text:"sᴘᴇᴄᴛᴀᴛᴏʀs",color:"red"}]
...
data modify entity @e[type=minecraft:text_display,tag=ff_settings_chat_label,limit=1] text set value [{text:"ᴄʜᴀᴛ",color:"green"}]
execute if entity @a[team=ff_guard,tag=ff_settings_chat_hidden,limit=1] run data modify entity @e[type=minecraft:text_display,tag=ff_settings_chat_label,limit=1] text set value [{text:"ᴄʜᴀᴛ",color:"red"}]
...
data modify entity @e[type=minecraft:text_display,tag=ff_settings_speedrun_label,limit=1] text set value [{text:"sᴘᴇᴇᴅʀᴜɴ",color:"gray"}]
execute if score $settings_mode ff_game_state matches 0 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_speedrun_label,limit=1] text set value [{text:"sᴘᴇᴇᴅʀᴜɴ",color:"red"}]
execute if score $settings_mode ff_game_state matches 0 if entity @a[team=ff_guard,tag=ff_settings_speedrun_show,limit=1] run data modify entity @e[type=minecraft:text_display,tag=ff_settings_speedrun_label,limit=1] text set value [{text:"sᴘᴇᴇᴅʀᴜɴ",color:"green"}]
...
data modify entity @e[type=minecraft:text_display,tag=ff_settings_randomizer_label,limit=1] text set value [{text:"ʀᴀɴᴅᴏᴍ",color:"gray"}]
execute if score $settings_mode ff_game_state matches 2 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_randomizer_label,limit=1] text set value [{text:"ʀᴀɴᴅᴏᴍ",color:"red"}]
execute if score $settings_mode ff_game_state matches 2 if entity @a[tag=ff_settings_randomizer_on,limit=1] run data modify entity @e[type=minecraft:text_display,tag=ff_settings_randomizer_label,limit=1] text set value [{text:"ʀᴀɴᴅᴏᴍ",color:"green"}]
