...
execute if score $settings_music_off ff_game_state matches 1 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_music_label,limit=1] text set value {translate:"ff.settings.board.music",color:"red"}
...
execute if score $settings_spectator_deny ff_game_state matches 1 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_spectators_label,limit=1] text set value {translate:"ff.settings.board.spectators",color:"red"}
...
execute if score $settings_chat_hidden ff_game_state matches 1 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_chat_label,limit=1] text set value {translate:"ff.settings.board.chat",color:"red"}
...
execute if score $settings_mode ff_game_state matches 0 if score $settings_speedrun_show ff_game_state matches 1 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_speedrun_label,limit=1] text set value {translate:"ff.settings.board.speedrun",color:"green"}
...
execute if score $settings_mode ff_game_state matches 2 if score $settings_randomizer_on ff_game_state matches 1 run data modify entity @e[type=minecraft:text_display,tag=ff_settings_randomizer_label,limit=1] text set value {translate:"ff.settings.board.random",color:"green"}
