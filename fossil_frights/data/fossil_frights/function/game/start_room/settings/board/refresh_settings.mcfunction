...
execute unless predicate fossil_frights:world/packs_enabled/plugin run data modify entity @e[type=minecraft:text_display,tag=ff_settings_chat_icon,limit=1] text set value [{text:"",font:"fossil-frights:settings_board",color:"white"}]
...
execute unless predicate fossil_frights:world/packs_enabled/plugin run data modify entity @e[type=minecraft:text_display,tag=ff_settings_chat_label,limit=1] text set value {translate:"ff.settings.board.chat",font:"fossil-frights:small_caps",color:"gray"}
