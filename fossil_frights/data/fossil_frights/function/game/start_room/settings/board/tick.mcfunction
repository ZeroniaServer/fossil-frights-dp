...
execute as @a[tag=ff_settings_hovering] unless predicate fossil_frights:game/start_room/settings/looking_at run title @s actionbar ""
...
title @a[tag=ff_settings_hovering] actionbar {translate:"ff.settings.hover.info",color:"yellow",italic:false}
