...
execute if score $party_mode_active ff_game_state matches 1.. as @a[team=ff_guard] if predicate fossil_frights:player/start_room/settings/looking_at_speedrun run title @s actionbar {translate:"ff.settings.hover.frights_only",color:"gray",italic:false}
execute if score $heist_mode_active ff_game_state matches 1.. as @a[team=ff_guard] if predicate fossil_frights:player/start_room/settings/looking_at_speedrun run title @s actionbar {translate:"ff.settings.hover.frights_only",color:"gray",italic:false}
execute unless score $heist_mode_active ff_game_state matches 1.. as @a[team=ff_guard] if predicate fossil_frights:player/start_room/settings/looking_at_randomizer run title @s actionbar {translate:"ff.settings.hover.heists_only",color:"gray",italic:false}
