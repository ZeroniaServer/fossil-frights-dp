...
# Mode labels
summon minecraft:text_display 16.125625 71.95875 27.59375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_frights"],billboard:"fixed",Rotation:[270f,0f],alignment:"left",background:0,shadow:true,text_opacity:0b,text:[{translate:"ff.settings.board.gamemode.frights",color:"white",with:[{translate:"ff.settings.board.gamemode.frights.name",color:"yellow"}]}],transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
summon minecraft:text_display 16.125625 71.95875 27.71375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_party"],billboard:"fixed",Rotation:[270f,0f],alignment:"left",background:0,shadow:true,text_opacity:0b,text:[{translate:"ff.settings.board.gamemode.party",color:"white",with:[{translate:"ff.settings.board.gamemode.party.name",color:"yellow"}]}],transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
summon minecraft:text_display 16.125625 71.95875 27.67375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_heists"],billboard:"fixed",Rotation:[270f,0f],alignment:"left",background:0,shadow:true,text_opacity:0b,text:[{translate:"ff.settings.board.gamemode.heists",color:"white",with:[{translate:"ff.settings.board.gamemode.heists.name",color:"yellow"}]}],transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
