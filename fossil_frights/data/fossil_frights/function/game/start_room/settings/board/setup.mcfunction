...
# Mode labels
summon minecraft:text_display 16.125625 71.95875 27.59375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_frights"],billboard:"fixed",Rotation:[270f,0f],alignment:"center",background:0,shadow:true,text_opacity:255,text:{translate:"ff.settings.board.gamemode.frights.name",font:"fossil-frights:small_caps",color:"gray"},transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
summon minecraft:text_display 16.125625 71.95875 27.71375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_party"],billboard:"fixed",Rotation:[270f,0f],alignment:"center",background:0,shadow:true,text_opacity:255,text:{translate:"ff.settings.board.gamemode.party.name",font:"fossil-frights:small_caps",color:"gray"},transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
summon minecraft:text_display 16.125625 71.95875 27.67375 {Tags:["ff_settings_board_entity","ff_settings_mode_label_heists"],billboard:"fixed",Rotation:[270f,0f],alignment:"center",background:0,shadow:true,text_opacity:255,text:{translate:"ff.settings.board.gamemode.heists.name",font:"fossil-frights:small_caps",color:"gray"},transformation:{right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.65f,0.65f,0.65f]}}
