...
execute as @a[team=ff_thief] run function fossil_frights:join/lobby
execute as @a[team=ff_guard,tag=!ff_settings_mode_owner] run function fossil_frights:join/lobby
