...
summon minecraft:text_display 20.5 72.1 28.97 {Tags:["ff_day_button_label"],text:"",billboard:"fixed",Rotation:[180,0],background:1073741824,default_background:true,shadow:true,brightness:{sky:15,block:15},width:5,height:1}
