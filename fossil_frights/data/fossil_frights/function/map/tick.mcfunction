...
execute if score $museum_map_flash ff_game_state matches ..9 as @e[type=minecraft:item_display,tag=museum_map] run data modify entity @s Glowing set value true
