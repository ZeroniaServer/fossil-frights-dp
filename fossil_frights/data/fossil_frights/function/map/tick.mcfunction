...
# Flashes map when no longer giving player free map, after run 10 or beating day 9, whichever first.
execute positioned 2.5 80.5 17.5 unless entity @a[limit=1,team=ff_guard,tag=!ff_map_claimed,scores={ff_run_count=..9,ff_top_day=..9},distance=..10] run return 0
