...
title @s actionbar [{"translate":"ff.messages.info","color":"yellow","with":[{"translate":"ff.messages.info.up_next","with":[{"score":{"name":"@s","objective":"ff_queue_prompt_display"},"color":"gold"}]}]}]
