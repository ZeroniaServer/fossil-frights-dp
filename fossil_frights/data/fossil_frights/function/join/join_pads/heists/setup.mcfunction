...
execute positioned -0.75 80.0 8.0 rotated 0 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/join_pads/thieves_beam",nbt:{Tags:["ff_join_heist_pad"],brightness:{sky:15,block:15},transformation:{right_rotation:[0,0,0,1],scale:[2.499,1,1.999],left_rotation:[0,0,0,1],translation:[0,0,0]},width:2.5,height:1}}
execute positioned 1.75 80.0 8.0 rotated 0 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/join_pads/guards_beam",nbt:{Tags:["ff_join_heist_pad"],brightness:{sky:15,block:15},transformation:{right_rotation:[0,0,0,1],scale:[2.499,1,1.999],left_rotation:[0,0,0,1],translation:[0,0,0]},width:2.5,height:1}}
