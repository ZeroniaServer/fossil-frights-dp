...
execute positioned 1.75 80.0 8.0 rotated 0 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/join_pads/queue_beam",nbt:{Tags:["ff_join_queue_pad"],brightness:{sky:15,block:15},item_display:"fixed",transformation:{right_rotation:[1,0,0,0],scale:[2.49,1.999,1],left_rotation:[0.7071068,0,0,0.7071068],translation:[0,-0.5075,0]},width:2.5,height:1}}
execute positioned -0.75 80.0 8.0 rotated 0 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/join_pads/spectate_beam",nbt:{Tags:["ff_join_spectator_pad"],brightness:{sky:15,block:15},item_display:"fixed",transformation:{right_rotation:[1,0,0,0],scale:[2.499,1.999,1],left_rotation:[0.7071068,0,0,0.7071068],translation:[0,-0.5075,0]},width:2.5,height:1}}
