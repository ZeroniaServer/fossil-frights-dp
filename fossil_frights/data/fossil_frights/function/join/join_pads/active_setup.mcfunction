...
execute positioned 0.5 80 8.0 rotated 0 0 run function fossil_frights:items/util/summon_item_display {loot_table:"fossil_frights:display/join_pads/join_beam",nbt:{Tags:["ff_join_active_pad"],brightness:{sky:15,block:15},transformation:{right_rotation:[0,0,0,1],scale:[4.999,1,1.999],left_rotation:[0,0,0,1],translation:[0,0,0]},width:5,height:1}}
