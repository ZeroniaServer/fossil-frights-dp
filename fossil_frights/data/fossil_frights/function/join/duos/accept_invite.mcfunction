execute unless score $invite_pending ff_game_state matches 1 run function fossil_frights:messages/duos/no_pending_invite
...
execute unless score @s ff_active_uuid_0 = $invite_target ff_active_uuid_0 run function fossil_frights:messages/duos/not_your_invite
execute unless score @s ff_active_uuid_0 = $invite_target ff_active_uuid_0 run return 0
execute unless score @s ff_active_uuid_1 = $invite_target ff_active_uuid_1 run function fossil_frights:messages/duos/not_your_invite
execute unless score @s ff_active_uuid_1 = $invite_target ff_active_uuid_1 run return 0
execute unless score @s ff_active_uuid_2 = $invite_target ff_active_uuid_2 run function fossil_frights:messages/duos/not_your_invite
execute unless score @s ff_active_uuid_2 = $invite_target ff_active_uuid_2 run return 0
execute unless score @s ff_active_uuid_3 = $invite_target ff_active_uuid_3 run function fossil_frights:messages/duos/not_your_invite
execute unless score @s ff_active_uuid_3 = $invite_target ff_active_uuid_3 run return 0
function fossil_frights:game/party/add_invited_player
