...
execute unless entity @s[tag=ff_invite_join_source] if score $game_running ff_game_state matches 0 if score $active_set ff_game_state matches 0 run function fossil_frights:game/set_active_player
