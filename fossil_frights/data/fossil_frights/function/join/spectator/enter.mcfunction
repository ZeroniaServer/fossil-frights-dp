...
execute if score $game_running ff_game_state matches 1 if score $settings_spectator_deny ff_game_state matches 1 run function fossil_frights:messages/error/spectating_disabled
execute if score $game_running ff_game_state matches 1 if score $settings_spectator_deny ff_game_state matches 1 run return 0
