...
scoreboard objectives add ff_hoverboard_damage_0 dummy
scoreboard objectives add ff_hoverboard_damage_1 dummy
scoreboard objectives add ff_hoverboard_damage_2 dummy
scoreboard objectives add ff_hoverboard_damage_3 dummy
scoreboard objectives add ff_hoverboard_damage_4 dummy
scoreboard objectives add ff_hoverboard_damage_5 dummy
scoreboard objectives add ff_hoverboard_damage_6 dummy
scoreboard objectives add ff_hoverboard_damage_7 dummy
scoreboard objectives add ff_hoverboard_damage_8 dummy
...
scoreboard players set #34 ff_constant 34
...
function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/default
...
schedule function fossil_frights:util/player/extinguish/cleanup 1t
