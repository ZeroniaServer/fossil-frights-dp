...
execute at @e[type=minecraft:interaction,tag=ff_lock_click,sort=nearest,limit=1,distance=..3] positioned ~ ~0.25 ~ if entity @e[type=minecraft:item_display,tag=ff_key_anim,distance=..0.5,limit=1] run return 0
