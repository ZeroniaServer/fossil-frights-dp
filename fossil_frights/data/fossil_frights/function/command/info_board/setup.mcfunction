...
execute if predicate fossil_frights:world/packs_enabled/plugin run function fossil_frights:command/info_board/set_plugin_text
execute unless predicate fossil_frights:world/packs_enabled/plugin run function fossil_frights:command/info_board/set_trigger_text
