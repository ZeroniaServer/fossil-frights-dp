...
execute if entity @s[tag=ff_ant_fight] run function fossil_frights:messages/leave/player_left
execute if entity @s[tag=ff_ant_fight] run return run function fossil_frights:lobby_games/ant_fight/exit
execute if score @s ff_parkour_running matches 1.. run function fossil_frights:messages/leave/player_left
execute if score @s ff_parkour_running matches 1.. run return run function fossil_frights:lobby_games/parkour/end
execute if score @s ff_temple_run_running matches 1.. run function fossil_frights:messages/leave/player_left
execute if score @s ff_temple_run_running matches 1.. run return run function fossil_frights:lobby_games/temple_run/end
execute if entity @s[tag=ff_sulfur_strikers] run function fossil_frights:messages/leave/player_left
execute if entity @s[tag=ff_sulfur_strikers] run return run function fossil_frights:lobby_games/sulfur_strikers/exit
execute if entity @s[tag=ff_in_queue] run function fossil_frights:messages/leave/player_left
