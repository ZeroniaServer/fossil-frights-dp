...
execute unless score @s ff_top_time matches 1.. run tellraw @s [{"translate":"ff.stats.best_time.empty","color":"yellow","with":[{"text":"--:--.--","color":"gray"}]}]
