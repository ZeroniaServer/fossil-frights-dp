# Start Frights if necessary, then enable Party only in a valid waiting room.
...
execute if predicate fossil_frights:player/is_playing unless score $party_mode_active ff_game_state matches 1 unless score $heist_mode_active ff_game_state matches 1 run function fossil_frights:game/party/activate
