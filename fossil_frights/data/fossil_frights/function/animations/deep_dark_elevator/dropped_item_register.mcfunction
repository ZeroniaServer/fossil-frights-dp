...
execute if entity @e[limit=1,type=minecraft:item_display,tag=ff_deep_dark_elevator.is_moving] run summon minecraft:item_display ~ ~ ~ {Tags:["ff_deep_dark_elevator_seat"],teleport_duration:1,view_range:0,width:0.001,height:0.001}
