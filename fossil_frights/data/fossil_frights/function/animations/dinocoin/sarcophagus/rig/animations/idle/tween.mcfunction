...
tag @s add animation.talking_skull.animation.idle.playing
...
execute at @s run function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/idle/zzz/apply_frame {frame: $(to_frame)}
