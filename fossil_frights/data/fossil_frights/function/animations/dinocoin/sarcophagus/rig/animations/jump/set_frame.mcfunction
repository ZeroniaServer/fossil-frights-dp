...
$execute store result storage fossil_frights:vending_machine_aj_temp args.frame int 1 run scoreboard players set @s aj.jump.frame $(frame)
execute at @s run function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/jump/zzz/set_frame with storage fossil_frights:vending_machine_aj_temp args