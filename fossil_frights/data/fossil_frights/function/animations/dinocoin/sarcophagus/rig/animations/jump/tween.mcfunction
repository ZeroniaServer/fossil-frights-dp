...
function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/pause_all
tag @s add animation.talking_skull.animation.jump.playing
...
execute at @s run function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/jump/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/dinocoin/sarcophagus/rig/animations/jump/zzz/apply_frame {frame: $(to_frame)}
