...
execute as @a[predicate=fossil_frights:player/is_playing,tag=!ff_fade_tp_active,x=79,y=74,z=78,dx=0,dy=0,dz=1] run title @s times 5 3 10
execute as @a[predicate=fossil_frights:player/is_playing,tag=!ff_fade_tp_active,x=79,y=74,z=78,dx=0,dy=0,dz=1] run title @s title {"text":"","font":"fossil-frights:title_overlays/fade_black","italic":false,"shadow_color":0}
scoreboard players set @a[predicate=fossil_frights:player/is_playing,tag=!ff_fade_tp_active,x=79,y=74,z=78,dx=0,dy=0,dz=1] ff_tp_action 12
