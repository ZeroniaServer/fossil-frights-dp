...
return run function fossil_frights:animations/dinocoin/vending_machine/runtime/util/zzz/1 with storage fossil_frights:vending_machine_aj_temp entry.data