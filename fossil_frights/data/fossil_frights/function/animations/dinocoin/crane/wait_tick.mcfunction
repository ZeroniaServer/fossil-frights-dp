execute if score $crane_wait ff_game_state matches 1.. if score $crane_activation_team ff_game_state matches 1 run particle minecraft:trial_omen 51 69.5 59 0 0.1 0 0 1
execute if score $crane_wait ff_game_state matches 1.. unless score $crane_activation_team ff_game_state matches 1 run particle minecraft:end_rod 51 69.5 59 0 0.1 0 0.01 1
