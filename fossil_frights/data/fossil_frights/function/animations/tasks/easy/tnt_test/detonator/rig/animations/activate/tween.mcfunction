...
function fossil_frights:animations/tasks/easy/tnt_test/detonator/rig/animations/pause_all
tag @s add animation.detonator.animation.activate.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.activate.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function fossil_frights:animations/tasks/easy/tnt_test/detonator/rig/animations/activate/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/tasks/easy/tnt_test/detonator/rig/animations/activate/zzz/apply_frame {frame: $(to_frame)}
