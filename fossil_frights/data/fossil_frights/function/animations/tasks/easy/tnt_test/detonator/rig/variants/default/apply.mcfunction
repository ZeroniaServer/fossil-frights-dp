...
function fossil_frights:animations/tasks/easy/tnt_test/detonator/rig/variants/default/zzz/0 with storage fossil_frights:vending_machine_aj_temp entry.data.uuids_by_name
return 1