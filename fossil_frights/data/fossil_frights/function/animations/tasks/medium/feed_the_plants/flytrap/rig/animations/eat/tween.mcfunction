...
function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/rig/animations/pause_all
tag @s add animation.carnivorous_flytrap.animation.eat.playing
...
execute at @s run function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/rig/animations/eat/zzz/apply_frame {frame: 0}
$execute at @s run function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/rig/animations/eat/zzz/apply_frame {frame: $(to_frame)}
