...
execute at @s run function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/rig/animations/eat/zzz/set_frame with storage fossil_frights:vending_machine_aj_temp args