...
execute positioned 23.5 94 70.5 as @e[type=minecraft:item_display,tag=animation.carnivorous_flytrap.root,distance=..3,sort=nearest,limit=1] at @s run function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/set_rest_pose
...
execute positioned 21.5 95 68.5 as @e[type=minecraft:item_display,tag=animation.carnivorous_flytrap.root,distance=..3,sort=nearest,limit=1] at @s run function fossil_frights:animations/tasks/medium/feed_the_plants/flytrap/set_rest_pose
