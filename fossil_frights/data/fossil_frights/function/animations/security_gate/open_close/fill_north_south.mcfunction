...
$execute align y positioned ^$(half_width) ^ ^ positioned ^-0.5 ^0.5 ^ run fill ^-$(width_minus_one) ^ ^ ~ $(max_y_minus_one) ~ pink_stained_glass_pane[east=true,west=true] replace air strict
