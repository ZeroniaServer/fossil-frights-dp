execute unless function fossil_frights:interactions/door/fake_pressure_plate/check run return 0
...
schedule function fossil_frights:interactions/door/fake_pressure_plate/unpress 20t append
