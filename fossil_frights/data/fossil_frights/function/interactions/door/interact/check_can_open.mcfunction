...
execute if score #can_open ff_dummy matches 1 if entity @s[tag=ff_door.automatic] run schedule function fossil_frights:interactions/door/walk_next_to/checker 1t append
