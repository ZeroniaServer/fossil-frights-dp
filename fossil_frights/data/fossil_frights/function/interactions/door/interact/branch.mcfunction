...
execute if score #can_open ff_dummy matches 0 align xyz positioned ~-0.001 ~-0.001 ~-0.001 as @e[dx=0.002,dy=0.002,dz=0.002,type=minecraft:item_display,tag=ff_door] at @s run return run function fossil_frights:interactions/door/shake/start
execute if score #can_open ff_dummy matches 1 align xyz positioned ~-0.001 ~-0.001 ~-0.001 as @e[dx=0.002,dy=0.002,dz=0.002,type=minecraft:item_display,tag=ff_door] at @s run return run function fossil_frights:interactions/door/toggle_state
