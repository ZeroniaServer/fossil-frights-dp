...
execute if score #sign_mounted ff_dummy matches 1 run data modify entity @s[tag=!ff_door.sign_is_mounted] width set value 0.252
execute if score #sign_mounted ff_dummy matches 1 run tag @s add ff_door.sign_is_mounted
execute if score #sign_mounted ff_dummy matches 1 run tp @s[tag=ff_door.part_0] ^0.375 ^ ^-0.46875
execute if score #sign_mounted ff_dummy matches 1 run tp @s[tag=ff_door.part_1] ^0.125 ^ ^-0.46875
execute if score #sign_mounted ff_dummy matches 1 run tp @s[tag=ff_door.part_2] ^-0.125 ^ ^-0.46875
execute if score #sign_mounted ff_dummy matches 1 run tp @s[tag=ff_door.part_3] ^-0.375 ^ ^-0.46875
