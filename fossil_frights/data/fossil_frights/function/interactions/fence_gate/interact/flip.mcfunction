...
execute if score #flip ff_dummy matches 1 run return run data modify entity @s data.ff_fence_gate.block_facing set value "north"
...
execute if score #flip ff_dummy matches 1 run return run data modify entity @s data.ff_fence_gate.block_facing set value "south"
...
execute if score #flip ff_dummy matches 1 run return run data modify entity @s data.ff_fence_gate.block_facing set value "west"
...
execute if score #flip ff_dummy matches 1 run return run data modify entity @s data.ff_fence_gate.block_facing set value "east"
