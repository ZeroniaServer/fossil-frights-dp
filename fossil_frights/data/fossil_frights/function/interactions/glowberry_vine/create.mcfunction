...
data modify storage fossil_frights:glowberry entity_data set value {Tags:["ff_glowberry_vine"],data:{ff_glowberry_vine:{picked:0b}},response:true,width:1.001,height:1.1}
