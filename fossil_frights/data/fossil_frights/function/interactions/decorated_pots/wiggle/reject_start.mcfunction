execute align xyz positioned ~0.5 ~ ~0.5 if entity @s[distance=..0.01] run tag @s add ff_decorated_pot.centered
...
data merge entity @s {start_interpolation:0,interpolation_duration:2,transformation:{translation:[0f,0.5f,0f],scale:[2f,2f,2f],left_rotation:[0f,0.05233596f,0f,0.99862953f],right_rotation:[0f,0f,0f,1f]}}
