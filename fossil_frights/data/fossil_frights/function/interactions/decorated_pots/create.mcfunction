...
execute positioned ~ ~-1 ~ align xyz positioned ~0.5 ~0.5 ~0.5 run function fossil_frights:interactions/decorated_pots/create/summon_display with storage fossil_frights:decorated_pot
