execute if predicate fossil_frights:game_state/heist_mode_active run function fossil_frights:admin/menu/heists/timer/unpause
...
function fossil_frights:game/frights/timer/start
