execute if predicate fossil_frights:world/packs_enabled/plugin run function fossil_frights:admin/menu/plugin/timer/show
execute if predicate fossil_frights:world/packs_enabled/plugin run return 0
execute if predicate fossil_frights:game_state/heist_mode_active run function fossil_frights:admin/menu/heists/timer/show
...
execute if score $timer_frozen ff_day matches 1 run function fossil_frights:admin/menu/timer/show_paused
execute unless score $timer_frozen ff_day matches 1 run function fossil_frights:admin/menu/timer/show_running
