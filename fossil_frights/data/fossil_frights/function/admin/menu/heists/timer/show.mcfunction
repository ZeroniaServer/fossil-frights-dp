execute if predicate fossil_frights:world/packs_enabled/plugin run function fossil_frights:admin/menu/plugin/heists/timer/show
...
execute if score $timer_frozen ff_day matches 1 run function fossil_frights:admin/menu/heists/timer/show_paused
execute if score $timer_frozen ff_day matches 1 run return 0
function fossil_frights:admin/menu/heists/timer/show_running
