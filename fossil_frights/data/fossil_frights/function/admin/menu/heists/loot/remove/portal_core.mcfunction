execute if score $loot_portal_core ff_heist_loot_state matches 3 run scoreboard players operation $heist_loot ff_heist -= $loot_portal_core ff_heist_loot_value
