...
playsound minecraft:entity.skeleton_ambient master @a 25 93 11 2 0.6
playsound minecraft:entity.wither_skeleton.ambient master @a 25 93 11 1.5 0.8
summon minecraft:skeleton 25 93 11 {Tags:["ff_skeleton_fright"],PersistenceRequired:1b,Rotation:[90f,0f],Health:1f}
