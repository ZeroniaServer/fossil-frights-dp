...
function fossil_frights:tasks/tracker/update_sidebar/medium_task {"task": "ancient_portal"}
...
function fossil_frights:tasks/tracker/update_sidebar/medium_task {"task": "fix_sculker"}
...
function fossil_frights:tasks/tracker/update_sidebar/hard_task {"task": "holy_grail"}
function fossil_frights:tasks/tracker/update_sidebar/hard_task {"task": "hoveraptor"}
function fossil_frights:tasks/tracker/update_sidebar/hard_task {"task": "pig_wrangler"}
