...
execute if score $swat_flies_sel ff_task_state matches 1 if score $swat_flies_done ff_task_state matches 0 positioned -13 95 54 run playsound minecraft:entity.bee.hurt master @a[team=ff_guard,distance=..12] ~ ~ ~ 0.5 1.6
