...
execute if score $static_buildup_sel ff_task_state matches 1 if score $static_buildup_done ff_task_state matches 0 run effect give @s minecraft:poison 1 0 true
execute if score $static_buildup_sel ff_task_state matches 1 if score $static_buildup_done ff_task_state matches 0 run effect give @s minecraft:glowing 3 0 true
execute if score $static_buildup_sel ff_task_state matches 1 if score $static_buildup_done ff_task_state matches 0 at @s run summon minecraft:lightning_bolt ~ ~ ~
execute if score $static_buildup_sel ff_task_state matches 1 if score $static_buildup_done ff_task_state matches 0 at @s run particle minecraft:end_rod ~ ~1 ~ 0.35 0.6 0.35 0.05 45 force @s
execute if score $static_buildup_sel ff_task_state matches 1 if score $static_buildup_done ff_task_state matches 0 run playsound minecraft:entity.lightning_bolt.thunder master @s ~ ~ ~ 0.7 1.8
