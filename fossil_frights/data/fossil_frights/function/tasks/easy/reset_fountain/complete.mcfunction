...
execute if score $reset_fountain_sel ff_task_state matches 1 if score $reset_fountain_done ff_task_state matches 0 run data modify storage fossil_frights:tasks complete.task_name set value "reset_fountain"
...
execute if score $reset_fountain_sel ff_task_state matches 1 if score $reset_fountain_done ff_task_state matches 0 as @a[tag=ff_frights_feedback_viewer] at @s run playsound minecraft:block.bubble_column.upwards_inside master @s ~ ~ ~ 0.7 1.4
...
execute if score $reset_fountain_sel ff_task_state matches 1 if score $reset_fountain_done ff_task_state matches 0 run clear @a[team=ff_guard] minecraft:written_book[minecraft:custom_data~{ff_task_book:"reset_fountain"}] 1
