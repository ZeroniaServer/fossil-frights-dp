...
execute if score $fix_cracked_egg_sel ff_task_state matches 1 if score $fix_cracked_egg_done ff_task_state matches 0 positioned 18.5 95.6 58.5 run playsound minecraft:entity.egg master @a[team=ff_guard,distance=..12] ~ ~ ~ 0.9 1.0
