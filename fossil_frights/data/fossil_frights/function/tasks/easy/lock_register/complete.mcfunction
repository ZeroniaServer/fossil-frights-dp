...
execute if score $lock_register_sel ff_task_state matches 1 if score $lock_register_done ff_task_state matches 0 as @a[tag=ff_frights_feedback_viewer] at @s run playsound fossil-frights:task.lock_register master @s ~ ~ ~ 0.9 1.0
execute if score $lock_register_sel ff_task_state matches 1 if score $lock_register_done ff_task_state matches 0 as @a[tag=ff_frights_feedback_viewer] at @s run playsound minecraft:block.chest.locked master @s ~ ~ ~ 0.9 1.0
