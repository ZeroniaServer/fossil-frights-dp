...
execute if score $check_ankylo_sel ff_task_state matches 1 if score $check_ankylo_done ff_task_state matches 0 as @a[tag=ff_frights_feedback_viewer] at @s run playsound fossil-frights:task.check_ankylo master @s ~ ~ ~ 0.9 1.0
execute if score $check_ankylo_sel ff_task_state matches 1 if score $check_ankylo_done ff_task_state matches 0 as @a[tag=ff_frights_feedback_viewer] at @s run playsound minecraft:entity.camel.ambient master @s ~ ~ ~ 0.9 0.8
