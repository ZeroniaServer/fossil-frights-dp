...
execute if entity @e[limit=1,type=minecraft:item_display,tag=ff_spilled_popcorn] run particle minecraft:item{item:{id:"minecraft:stone",components:{"minecraft:item_model":"fossil-frights:spilled_popcorn"}}} 10.07 69.2 69.39 0.4 0 0.4 0.1 20
