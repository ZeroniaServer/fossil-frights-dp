...
execute if score $sweep_popcorn_sel ff_task_state matches 1 if score $sweep_popcorn_done ff_task_state matches 0 at @s run playsound fossil-frights:task.sweep_popcorn master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.9 1.0
