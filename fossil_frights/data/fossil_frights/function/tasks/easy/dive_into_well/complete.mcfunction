...
execute if score $dive_into_well_sel ff_task_state matches 1 if score $dive_into_well_done ff_task_state matches 0 at @s run playsound minecraft:entity.generic.splash master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.9 1.0
