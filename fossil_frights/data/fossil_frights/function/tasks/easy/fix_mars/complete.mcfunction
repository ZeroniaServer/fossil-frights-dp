...
execute if score $fix_mars_sel ff_task_state matches 1 if score $fix_mars_done ff_task_state matches 0 positioned -22.5 103.0 70.5 run playsound minecraft:block.sand.place master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
