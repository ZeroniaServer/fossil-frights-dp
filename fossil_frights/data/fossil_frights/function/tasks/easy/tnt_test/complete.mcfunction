...
execute if score $tnt_test_sel ff_task_state matches 1 if score $tnt_test_done ff_task_state matches 0 run summon minecraft:tnt 44.5 64.25 82.5 {fuse:15,explosion_power:0,NoGravity:true,Tags:["ff_tnt_test"]}
