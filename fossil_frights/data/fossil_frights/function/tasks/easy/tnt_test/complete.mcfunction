...
execute if score $tnt_test_sel ff_task_state matches 1 if score $tnt_test_done ff_task_state matches 0 positioned 44 64 82 run playsound minecraft:entity.tnt.primed master @a[team=ff_guard,distance=..24] ~ ~ ~ 1.0 1.0
