...
execute if score $toilet_clog_sel ff_task_state matches 1 if score $toilet_clog_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound fossil-frights:task.toilet_clog master @s ~ ~ ~ 0.9 1.0
execute if score $toilet_clog_sel ff_task_state matches 1 if score $toilet_clog_done ff_task_state matches 0 as @a[team=ff_guard] at @s run playsound minecraft:entity.generic.splash master @s ~ ~ ~ 0.9 1.2
