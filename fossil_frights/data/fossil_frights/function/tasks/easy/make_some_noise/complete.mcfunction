...
execute positioned 61 72 71 run playsound minecraft:entity.warden.ambient player @a[tag=ff_frights_feedback_viewer,distance=..20] ~ ~ ~ 1.0 1.0
execute positioned 61 72 71 run playsound minecraft:block.sculk_sensor.clicking player @a[tag=ff_frights_feedback_viewer,distance=..20] ~ ~ ~ 0.8 1.0
...
clear @a[team=ff_guard] minecraft:written_book[minecraft:custom_data~{ff_task_book:"make_some_noise"}] 1
