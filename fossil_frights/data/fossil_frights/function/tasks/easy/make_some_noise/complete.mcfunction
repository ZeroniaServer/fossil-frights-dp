...
execute positioned 61 72 71 run playsound minecraft:entity.warden.ambient player @a[team=ff_guard,distance=..20] ~ ~ ~ 1.0 1.0
execute positioned 61 72 71 run playsound minecraft:block.sculk_sensor.clicking player @a[team=ff_guard,distance=..20] ~ ~ ~ 0.8 1.0
