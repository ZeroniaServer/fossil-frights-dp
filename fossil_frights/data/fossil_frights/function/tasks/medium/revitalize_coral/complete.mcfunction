...
execute if score $revitalize_coral_sel ff_task_state matches 1 if score $revitalize_coral_done ff_task_state matches 0 positioned -19.11 80.00 67.00 run function fossil_frights:game/heists/paint_fx/paint_water/spawn
