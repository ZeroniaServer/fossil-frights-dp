...
execute if score $coffee_top_up_sel ff_task_state matches 1 if score $coffee_top_up_done ff_task_state matches 0 positioned -21.5 70.5 35.5 run playsound fossil-frights:task.coffee_top_up master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
...
execute if score $coffee_top_up_sel ff_task_state matches 1 if score $coffee_top_up_done ff_task_state matches 0 positioned -21.5 70.5 35.5 run playsound minecraft:block.brewing_stand.brew block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.8 1.15
execute if score $coffee_top_up_sel ff_task_state matches 1 if score $coffee_top_up_done ff_task_state matches 0 positioned -21.5 70.5 35.5 run playsound minecraft:block.fire.extinguish block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.28 1.8
