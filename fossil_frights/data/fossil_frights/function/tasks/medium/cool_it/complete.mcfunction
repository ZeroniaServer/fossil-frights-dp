...
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 positioned 23.5 103.5 9.5 run playsound fossil-frights:task.cool_it master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
...
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 positioned 23.5 103.5 9.5 run playsound minecraft:block.glass.break block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.45 1.7
execute if score $cool_it_sel ff_task_state matches 1 if score $cool_it_done ff_task_state matches 0 positioned 23.5 103.5 9.5 run playsound minecraft:block.fire.extinguish block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.65 1.45
