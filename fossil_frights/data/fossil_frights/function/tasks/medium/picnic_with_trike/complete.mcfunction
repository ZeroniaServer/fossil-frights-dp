...
playsound fossil-frights:task.picnic_with_trike master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
playsound minecraft:entity.generic.eat player @a[team=ff_guard,distance=..18] ~ ~ ~ 0.8 1.0
