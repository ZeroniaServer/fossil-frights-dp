...
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 positioned 26.5 80.5 9.5 run playsound fossil-frights:task.smelly_toilet master @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
...
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 positioned 26.5 80.5 9.5 run playsound minecraft:item.bottle.empty block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.65 1.6
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 positioned 26.5 80.5 9.5 run playsound minecraft:entity.generic.splash block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.35 1.9
...
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 run clear @a[team=ff_guard] minecraft:written_book[minecraft:custom_data~{ff_task_book:"smelly_toilet"}] 1
