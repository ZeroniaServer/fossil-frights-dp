...
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 positioned 26.5 80.5 9.5 run playsound minecraft:item.bottle.empty block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.65 1.6
execute if score $smelly_toilet_sel ff_task_state matches 1 if score $smelly_toilet_done ff_task_state matches 0 positioned 26.5 80.5 9.5 run playsound minecraft:entity.generic.splash block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.35 1.9
