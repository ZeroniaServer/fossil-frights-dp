...
playsound minecraft:item.brush.brushing.sand block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.1
...
clear @a[team=ff_guard] minecraft:written_book[minecraft:custom_data~{ff_task_book:"bring_brush"}] 1
