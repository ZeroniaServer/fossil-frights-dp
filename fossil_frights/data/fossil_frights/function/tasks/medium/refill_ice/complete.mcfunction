...
execute if score $refill_ice_sel ff_task_state matches 1 if score $refill_ice_done ff_task_state matches 0 positioned 26 81.5 17 run playsound fossil-frights:task.refill_ice master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.9 1.0
...
execute if score $refill_ice_sel ff_task_state matches 1 if score $refill_ice_done ff_task_state matches 0 positioned 26 81.5 17 run playsound minecraft:block.powder_snow.place block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.8 0.8
execute if score $refill_ice_sel ff_task_state matches 1 if score $refill_ice_done ff_task_state matches 0 positioned 26 81.5 17 run playsound minecraft:block.glass.break block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.35 1.7
