...
execute positioned 60.5 82 73.5 run playsound minecraft:entity.generic.splash block @a[tag=ff_frights_feedback_viewer,distance=..22] ~ ~ ~ 0.8 1.4
execute positioned 60.5 82 73.5 run playsound minecraft:item.crop.plant block @a[tag=ff_frights_feedback_viewer,distance=..22] ~ ~ ~ 0.65 1.2
