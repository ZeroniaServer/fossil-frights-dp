...
execute if score $popcorn_buckets_sel ff_task_state matches 1 if score $popcorn_buckets_done ff_task_state matches 0 positioned 26.5 76 82.5 run playsound minecraft:block.dispenser.dispense master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.9 1.2
execute if score $popcorn_buckets_sel ff_task_state matches 1 if score $popcorn_buckets_done ff_task_state matches 0 positioned 26.5 76 82.5 run playsound minecraft:block.note_block.basedrum master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.65 1.8
