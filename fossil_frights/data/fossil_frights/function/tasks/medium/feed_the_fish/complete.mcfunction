...
execute if score $feed_the_fish_sel ff_task_state matches 1 if score $feed_the_fish_done ff_task_state matches 0 positioned 11 81 66 run playsound minecraft:block.bubble_column.bubble_pop block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.9 1.0
