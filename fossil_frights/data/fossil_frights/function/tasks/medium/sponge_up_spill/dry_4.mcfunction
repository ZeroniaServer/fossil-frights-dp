...
execute if score $sponge_up_spill_done ff_task_state matches 1 positioned -15.5 79.5 68.5 run playsound minecraft:item.bucket.fill block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.25 2.0
