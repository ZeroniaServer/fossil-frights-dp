...
execute at @e[type=minecraft:interaction,tag=ff_feed_the_plants_click,sort=nearest,limit=1,distance=..6] run function fossil_frights:tasks/medium/feed_the_plants/complete
