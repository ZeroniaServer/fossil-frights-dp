advancement revoke @s only fossil_frights:tasks/medium/feed_the_plants/click_northwest
...
function fossil_frights:tasks/medium/feed_the_plants/complete_northwest
