...
execute if score $refill_coffee_sel ff_task_state matches 1 if score $refill_coffee_done ff_task_state matches 0 positioned 16.5 81.5 23.5 run playsound fossil-frights:task.refill_coffee master @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.9 1.0
...
execute if score $refill_coffee_sel ff_task_state matches 1 if score $refill_coffee_done ff_task_state matches 0 positioned 16.5 81.5 23.5 run playsound minecraft:block.brewing_stand.brew block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.8 1.15
execute if score $refill_coffee_sel ff_task_state matches 1 if score $refill_coffee_done ff_task_state matches 0 positioned 16.5 81.5 23.5 run playsound minecraft:block.fire.extinguish block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.28 1.8
