...
execute if score $refill_coffee_sel ff_task_state matches 1 if score $refill_coffee_done ff_task_state matches 0 positioned 16.5 81.5 23.5 run playsound minecraft:block.fire.extinguish block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.28 1.8
