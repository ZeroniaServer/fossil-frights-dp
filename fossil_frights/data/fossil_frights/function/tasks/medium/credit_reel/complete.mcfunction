...
execute if score $credit_reel_sel ff_task_state matches 1 if score $credit_reel_done ff_task_state matches 0 positioned 25.5 77 75 run playsound fossil-frights:task.credit_reel master @a[tag=ff_frights_feedback_viewer,distance=..14] ~ ~ ~ 0.9 1.0
execute if score $credit_reel_sel ff_task_state matches 1 if score $credit_reel_done ff_task_state matches 0 positioned 25.5 77 75 run playsound minecraft:block.note_block.chime master @a[tag=ff_frights_feedback_viewer,distance=..14] ~ ~ ~ 0.8 1.2
