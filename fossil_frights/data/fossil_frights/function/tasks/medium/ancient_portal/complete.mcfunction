...
execute if score $ancient_portal_sel ff_task_state matches 1 if score $ancient_portal_done ff_task_state matches 0 positioned 51.5 72.0 51.5 run playsound minecraft:block.portal.ambient block @a[team=ff_guard,distance=..18] ~ ~ ~ 0.75 1.1
