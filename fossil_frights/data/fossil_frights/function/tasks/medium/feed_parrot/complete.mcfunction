...
execute if score $feed_parrot_sel ff_task_state matches 1 if score $feed_parrot_done ff_task_state matches 0 positioned 24 99 84 run playsound minecraft:entity.parrot.ambient block @a[tag=ff_frights_feedback_viewer,distance=..24] ~ ~ ~ 0.8 1.1
