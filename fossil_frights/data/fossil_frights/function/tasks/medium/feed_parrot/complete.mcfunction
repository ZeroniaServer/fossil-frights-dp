...
execute if score $feed_parrot_sel ff_task_state matches 1 if score $feed_parrot_done ff_task_state matches 0 positioned 24 99 84 run playsound fossil-frights:task.feed_parrot master @a[team=ff_guard,distance=..24] ~ ~ ~ 0.9 1.0
