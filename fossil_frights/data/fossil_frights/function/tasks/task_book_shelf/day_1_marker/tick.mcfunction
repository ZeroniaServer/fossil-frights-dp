...
execute if score $day_timer ff_day matches ..3599 as @a[team=ff_guard,scores={ff_run_count=1..2}] run function fossil_frights:player/actionbar/show/fallback_instruction/locator_bar.yellow
execute if score $day_timer ff_day matches 3600.. if score $day_1_book_marker_flash ff_day matches ..9 as @a[team=ff_guard,scores={ff_run_count=1..2}] run function fossil_frights:player/actionbar/show/fallback_instruction/locator_bar.yellow
execute if score $day_timer ff_day matches 3600.. if score $day_1_book_marker_flash ff_day matches 10..19 as @a[team=ff_guard,scores={ff_run_count=1..2}] run function fossil_frights:player/actionbar/show/fallback_instruction/locator_bar.white
