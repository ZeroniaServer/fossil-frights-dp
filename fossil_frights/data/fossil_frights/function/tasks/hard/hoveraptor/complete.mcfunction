...
execute positioned 21.5 104.5 42.5 run playsound fossil-frights:task.hoveraptor master @a[tag=ff_frights_feedback_viewer,distance=..24] ~ ~ ~ 0.9 1.0
...
execute positioned 21.5 104.5 42.5 run playsound minecraft:block.beacon.power_select master @a[tag=ff_frights_feedback_viewer,distance=..24] ~ ~ ~ 0.8 1.5
execute positioned 21.5 104.5 42.5 run playsound minecraft:entity.breeze.idle_air master @a[tag=ff_frights_feedback_viewer,distance=..24] ~ ~ ~ 0.8 1.25
