...
execute as @a[team=ff_guard] at @s run playsound fossil-frights:task.the_lost_code master @s ~ ~ ~ 0.9 1.0
execute as @a[team=ff_guard] at @s run playsound minecraft:entity.player.levelup player @s ~ ~ ~ 0.9 1.0
execute as @a[team=ff_guard] at @s run particle minecraft:totem_of_undying ~ ~1 ~ 0.45 0.7 0.45 0.2 52 force
