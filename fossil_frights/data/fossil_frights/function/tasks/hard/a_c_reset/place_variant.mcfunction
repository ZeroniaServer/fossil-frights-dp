execute if score $a_c_reset_variant ff_task_state matches 1 run place template fossil_frights:a_c/1 -10 103 56
execute if score $a_c_reset_variant ff_task_state matches 2 run place template fossil_frights:a_c/2 -10 103 56
execute if score $a_c_reset_variant ff_task_state matches 3 run place template fossil_frights:a_c/3 -10 103 56
