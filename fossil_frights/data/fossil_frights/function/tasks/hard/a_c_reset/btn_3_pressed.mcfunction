...
data modify storage fossil_frights:a_c_reset display.c3 set value "\ue501"
execute positioned 8 108 57 run playsound minecraft:entity.player.hurt_freeze block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.7 1.4
execute positioned 8 108 57 run playsound minecraft:block.powder_snow.break block @a[tag=ff_frights_feedback_viewer,distance=..18] ~ ~ ~ 0.6 1.2
execute positioned 8 108 57 run particle minecraft:snowflake ~ ~ ~ 0.3 0.3 0.3 0.05 15 force
