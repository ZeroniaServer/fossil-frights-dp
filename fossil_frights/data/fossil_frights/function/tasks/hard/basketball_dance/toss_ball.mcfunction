...
scoreboard players set $basketball_dance_head_tossed_once ff_task_state 1
...
execute positioned -25.0 81.3 34.5 run playsound minecraft:entity.item.pickup master @a[tag=ff_frights_feedback_viewer,distance=..20] ~ ~ ~ 0.8 0.7
