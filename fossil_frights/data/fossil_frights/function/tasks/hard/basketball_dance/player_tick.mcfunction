execute if score $heist_mode_active ff_game_state matches 1 if score $basketball_dance_timer ff_task_state matches 1.. run function fossil_frights:game/heists/loot/high/basketball_player_tick
