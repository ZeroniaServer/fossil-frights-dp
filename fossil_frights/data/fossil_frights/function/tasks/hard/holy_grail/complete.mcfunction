...
execute store result score $holy_grail_reward ff_task_state run random value 1..4
execute as @a[tag=ff_decorated_pot.player,limit=1] run function fossil_frights:tasks/hard/holy_grail/reward
