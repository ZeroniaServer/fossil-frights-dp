...
execute if score $final_task_dino ff_task_state matches 5 run function fossil_frights:tasks/final/final_task/preview_ambient/t_rex
execute if score $final_task_dino ff_task_state matches 6 run function fossil_frights:tasks/final/final_task/preview_ambient/velociraptor
