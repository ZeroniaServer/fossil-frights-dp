...
execute if score $final_task_item ff_task_state matches 8 if items entity @s weapon.mainhand *[minecraft:custom_data~{itemID:"pink_jelly"}] run function fossil_frights:tasks/final/final_task/click/centrifuge/accept/pink_jelly
