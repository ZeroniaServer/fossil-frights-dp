...
kill @e[type=minecraft:armor_stand,tag=ff_task_compass_target]
...
scoreboard players reset $tt_coffee_top_up ff_task_tracker
...
function fossil_frights:tasks/medium/coffee_top_up/reset
...
function fossil_frights:tasks/hard/evolution/reset
