...
execute if score $lb_scan_time ff_lb_calc matches 1.. run function fossil_frights:leaderboards/cache/consider_worst_time
execute if score $lb_scan_time ff_lb_calc matches ..0 if score $lb_scan_day ff_lb_calc matches 1.. run function fossil_frights:leaderboards/cache/consider_worst_day
