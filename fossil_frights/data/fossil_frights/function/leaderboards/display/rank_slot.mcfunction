...
function fossil_frights:leaderboards/display/scan_selected
...
$execute if score #lb_slot_$(slot)_index ff_lb_calc matches 0.. run function fossil_frights:leaderboards/display/mark_selected with storage fossil_frights:leaderboards slot_$(slot)
