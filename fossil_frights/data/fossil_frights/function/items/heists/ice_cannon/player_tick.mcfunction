...
execute if items entity @s weapon.mainhand *[custom_data~{ff_heist_ice_cannon_remote:true}] if items entity @s armor.head minecraft:carved_pumpkin[minecraft:custom_data~{ff_heist_security_hat:true}] run function fossil_frights:items/heists/ice_cannon/equip_cannon
