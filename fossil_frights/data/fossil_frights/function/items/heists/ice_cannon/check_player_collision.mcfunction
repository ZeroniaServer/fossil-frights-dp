...
execute positioned ~-0.5 ~-0.55 ~-0.5 if entity @a[limit=1,gamemode=!spectator,tag=!ff_ice_cannon_owner_match,dx=0,dy=0.1,dz=0] run scoreboard players set #impact ff_dummy 1
tag @a remove ff_ice_cannon_owner_match
