...
execute as @a[tag=ff_ice_freeze_owner,tag=ff_ice_frozen] run attribute @s minecraft:jump_strength base reset
execute as @a[tag=ff_ice_freeze_owner,tag=ff_ice_frozen] run attribute @s minecraft:entity_interaction_range base reset
