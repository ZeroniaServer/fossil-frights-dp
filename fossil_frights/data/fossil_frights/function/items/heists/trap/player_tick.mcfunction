...
execute if items entity @s weapon.mainhand *[custom_data~{ff_heist_trap:true}] unless score @s ff_heist_loot_security_actionbar matches 1.. unless score @s ff_trap_warn matches 1.. unless score @s ff_trap_invalid matches 1.. unless score @s ff_trap_pickup_feedback matches 1.. unless score @s ff_trap_no_pickup_feedback matches 1.. run function fossil_frights:items/heists/trap/ui/show
