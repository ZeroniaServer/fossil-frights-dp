...
execute if score @s ff_glowtrap_age matches 50.. if function fossil_frights:items/heists/trap/types/explosive/trigger_item/check_for run function fossil_frights:items/heists/trap/types/explosive/trigger_item
