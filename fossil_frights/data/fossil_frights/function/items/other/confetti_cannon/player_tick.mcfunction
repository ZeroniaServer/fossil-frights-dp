...
execute unless items entity @s weapon.mainhand minecraft:diamond_hoe[custom_data~{ff_confetti_remote:true}] if items entity @s armor.head *[minecraft:custom_data~{ff_confetti_cannon_hat:true}] run item replace entity @s armor.head with air
