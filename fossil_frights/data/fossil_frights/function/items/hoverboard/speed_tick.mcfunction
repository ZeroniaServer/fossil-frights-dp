...
execute unless entity @s[tag=ff_ice_frozen] if entity @s[tag=ff_holding_heavy] run attribute @s minecraft:movement_speed modifier remove fossil_frights:hoverboard_sprinting
