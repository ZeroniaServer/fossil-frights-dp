...
$loot replace entity @e[limit=1,dx=0,type=minecraft:item_display,tag=ff_summon_item_display_new] contents loot $(loot_table)
tp @e[limit=1,dx=0,type=minecraft:item_display,tag=ff_summon_item_display_new] ~ ~ ~ ~ ~
execute as @e[limit=1,dx=0,type=minecraft:item_display,tag=ff_summon_item_display_new] if items entity @s contents *[custom_data={ff_summon_item_display_delete:true}] run kill @s
tag @e[limit=1,dx=0,type=minecraft:item_display,tag=ff_summon_item_display_new] remove ff_summon_item_display_new
