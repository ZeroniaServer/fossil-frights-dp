...
function fossil_frights:lobby_games/temple_run/update_display
advancement grant @s only fossil_frights:03_lobby/temple_runner
function fossil_frights:messages/temple_run/completed
function fossil_frights:lobby_games/temple_run/update_personal_best
function fossil_frights:lobby_games/temple_run/check_best
