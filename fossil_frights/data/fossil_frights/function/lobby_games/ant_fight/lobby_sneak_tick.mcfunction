...
execute if score @s ff_ant_sneak_time > @s ff_ant_sneak_seen run function fossil_frights:lobby_games/ant_fight/lobby_sneak/sneaking
execute unless score @s ff_ant_sneak_time > @s ff_ant_sneak_seen run function fossil_frights:lobby_games/ant_fight/lobby_sneak/not_sneaking
