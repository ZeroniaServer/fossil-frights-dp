execute if entity @s[tag=ff_ant_fight] unless entity @s[gamemode=adventure,predicate=fossil_frights:player/is_lobby_freeplay] run function fossil_frights:lobby_games/ant_fight/exit
...
execute if entity @s[tag=ff_ant_fight,tag=ff_dropped_infinileaf] run function fossil_frights:lobby_games/ant_fight/exit_restore
...
execute if entity @s[tag=ff_ant_fight] if score @s ff_ant_combo_shown_until_timestamp > #gametime ff_ant_combo_shown_until_timestamp run title @s actionbar [{"translate":"ff.lobby.ant_fight.ant_score","color":"#71de75","with":[{"translate": "%s %s","with":[{"score":{"name":"@s","objective":"ff_ant_score"},"color":"white"},{"text":"","color":"green","extra":["(+",{"score":{"name":"@s","objective":"ff_ant_combo"}},")"]}]}]}]
...
execute if entity @s[gamemode=adventure,predicate=fossil_frights:player/is_lobby_freeplay] positioned -20.5 76.5 100.5 if entity @s[distance=..1.2] run function fossil_frights:lobby_games/ant_fight/enter
execute if entity @s[gamemode=adventure,predicate=fossil_frights:player/is_lobby_freeplay] positioned -52.5 77.5 95.5 if entity @s[distance=..1.2] run function fossil_frights:lobby_games/ant_fight/enter
execute if entity @s[gamemode=adventure,predicate=fossil_frights:player/is_lobby_freeplay] positioned -40 74 114 if entity @s[distance=..1.2] run function fossil_frights:lobby_games/ant_fight/enter
