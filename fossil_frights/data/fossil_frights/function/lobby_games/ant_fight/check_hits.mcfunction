...
execute if score #decremented ff_dummy matches 1 run title @s actionbar ["",{translate:"ff.lobby.ant_fight.ant_score",color:"#71de75",font:"fossil-frights:small_caps",with:[\
    ["",{score:{name:"@s",objective:"ff_ant_score"},color:"white"}," ",{color:"red",text:"(-1)"},{color:"gray",text:"    "},{translate:"ff.lobby.ant_fight.hit_by",color:"white",with:[{score:{name:"#ant_fight_attacker_name",objective:"ff_dummy"}}]}]\
    ]}]
...
execute if score #decremented ff_dummy matches 0 run title @s actionbar ["",{translate:"ff.lobby.ant_fight.ant_score",color:"#71de75",font:"fossil-frights:small_caps",with:[\
    ["",{score:{name:"@s",objective:"ff_ant_score"},color:"white"},{color:"gray",text:"    "},{translate:"ff.lobby.ant_fight.hit_by",color:"white",with:[{score:{name:"#ant_fight_attacker_name",objective:"ff_dummy"}}]}]\
    ]}]
