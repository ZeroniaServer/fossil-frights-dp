...
execute as @a[gamemode=adventure,tag=!ff_fade_tp_active,x=-18,y=80,z=-4,dx=0,dy=1,dz=0] run title @s times 5 3 10
execute as @a[gamemode=adventure,tag=!ff_fade_tp_active,x=-18,y=80,z=-4,dx=0,dy=1,dz=0] run title @s title {"text":"","font":"fossil-frights:title_overlays/fade_black","italic":false,"shadow_color":0}
scoreboard players set @a[gamemode=adventure,tag=!ff_fade_tp_active,x=-18,y=80,z=-4,dx=0,dy=1,dz=0] ff_tp_action 3
