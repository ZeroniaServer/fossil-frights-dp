...
execute if entity @s[team=ff_guard] run effect give @s minecraft:blindness 40 1 true
execute if entity @s[team=ff_guard] run effect give @s minecraft:slowness 200 1 true
